...
In the repository, at `pamphlets/north_wind_and_sun.md`, is *The North Wind and the Sun* — the story told in a thousand languages to show what each one sounds like, and the second text ever written in Phi. When it was written, it was a demonstration. For you, today, it is something better: a story in a language you read.
