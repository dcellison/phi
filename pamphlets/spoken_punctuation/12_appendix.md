...
| `mio` | mmhm | `sai` | ouch |
| `hao` | pardon | `halu` | aww |
| `mea` | thanks | `phuo` | phew |
| `soa` | sorry | `pio` | hehe |
| `hei` | hey | `teo` | watch out |
| `shiu` | shh | `hoi` | onward |

Each is a complete utterance with its own period, and each keeps its lexical meaning at any volume. Part 7 teaches the class by nearest neighbors.
...
- The interjections are twenty complete utterances; when two feel close, the entry's nearest neighbor decides.
- The colon, semicolon, parentheses, dash, and ellipsis have no Phi words because sentence structure, the discourse markers, and `nuo` already do their work.
