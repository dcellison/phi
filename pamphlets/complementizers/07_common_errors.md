...
**How to avoid:**
- Check: Does my embedded clause have a verb?
- Remember: `towe nai` (is well), not just `towe` (well)
...
4. **Types match?** Does each opener match its own closer type?
...
Most errors come from English interference:
- Omitting closers (English drops "that")
- Wrong word order (English is SVO)
- Confusing complementizer types (English is less systematic)
