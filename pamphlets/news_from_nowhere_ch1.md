...
lona mua ta shero reshi shareo to nai.
meeting LOC one night fast discuss PST be.
(At the meeting, one night, there was a brisk discussion.)
morris: "Up at the League, says a friend, there had been one night a brisk conversational discussion,"

punoa moreluki wireo philo.
society transform future day.
(The morrow of society's transformation.)
...
**Notes:** `ti` opens the chapter and does the whole frame's work in one word: everything that follows is secondhand, reported rather than witnessed, exactly as the original's recurring "says our friend" means. Phi's evidentiality system rarely gets to show off a use this clean. The meeting itself, its pace, and the transformation behind it are carried by `lona` (meeting), `reshi` (fast), and `moreluki` (transform), none of them coined for this text. The discussion's own timing is carried too: Morris sets the scene "one night," and `shero`, already at work two blocks later describing the night itself, states it here as a plain temporal adjunct, `ta shero`, needing no new word or construction. "The Morrow of the Revolution" names a specific point, the day after, not a vague future: `wireo philo`, the journal's own word for tomorrow (literally future day), takes `punoa moreluki` as its possessor and states the frame as its own fragment, following the same date-line pattern the journal uses for "today" and "yesterday."
