...
mia mena mia phea rena ru laeno thimu to ki nulae miona nai meno to phaelo.
...
rena sio luphore whano lo shiro wei mia ha to ka nila.
...
mia mua luera shero mena luphore phou lunei keru tiripe meno to ki hi nila.
...
shia wethalu phea rena mia to ki nila lo nosa riola wethalu to ma nai.
...
mia mena ha shewo nai meno to ke remo.
...
rena mia wakomi thena henoi to nai.
...
lo rena thumiro sepho sawa thena riola womu to ma manolu.
...
mia phea ha repha to ki po whemura. whekai mia phea ha repha mue rena lo kolai phelu shelu mawha thimu to ki nila.
...
mia mena lo thena wei loa nela pilu womu nai meno to ho remo.
...
BEHIND PL home large PL tree PST rise. MANY tree plane tree PST be.
(Behind the houses great trees rose, mostly planes.)
...
**Notes:** the banks compose from words the corpus already holds: brick is `mueri kerou`, clay-stone, exactly as the Babel text builds it, and the tiled roofs stay the same fired clay. Morris's boldest claim about the houses, that they look alive and sympathetic, keeps its full strangeness through `ke` and `phea`: they seemed like living things, like things that sense their dwellers' life, judgments confessed as inference rather than asserted as fact. `pilomu` (plane tree) is coined for the trees themselves: the first chapter's elm set the precedent that a landscape's own species earn real words, and Morris tells us most of these trees are planes, the dappled tree that lives with people. The blush composes as the face becoming red, and Barn Elms returns as `ra welamu lokue`, that elm-place, the same phrase Dick used from the boat, so the narrator's slip lands on ground the conversation has already named.
