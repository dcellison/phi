# Part 7: Walking verses 9–10: the circle closes

### Verse 9: in every posture
...
The posture list runs on `sola` the way verses 4–5 ran their pairs, and its job is the same: closing doors. Whatever position your body is in was just named, so no posture is the holy one and none is exempt. Then `ha thesua` (*this* mindfulness) and the deictic is doing something worth catching: by the time you read this line aloud, the nearest mindfulness at hand is the recitation itself. The text points at the practice of reading the text. Sustain *this*.

And then a line with no `su`. `ha shea menui nai.` is a statement (the first plain claim since verse 1's opening) and it is the hinge on which the ending turns.

### Verse 10: the wishing stops
...
**Micro-drill:** read verse 1's first line and verse 10's last line as a pair, aloud, twice. Name the verb that changed. Then name what the eight verses between them were for: in either language; one sentence. If your sentence contains the word *practice*, the text has already taught you to read it.
