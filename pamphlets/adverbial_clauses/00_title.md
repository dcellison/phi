...
- Repair the postposed frames that English word order keeps suggesting

This pamphlet assumes the particle system in manual chapter 9, the sentence patterns in chapter 10, and tense from chapter 14. Chapter 19 section 4 is its home ground; the `lu` condition belongs to Slot 0 and the three-slots pamphlet, and the closered complement frames belong to the complementizers pamphlet.
...
*Say what the work is for. Then begin the work.*
