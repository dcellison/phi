...
- Distinguish a productive Phi onym from a preferred source name preserved outside Phi

This pamphlet assumes the particle system (manual ch9) and the mindful sentence (ch10). It is a companion to manual chapters 21 and 24 and to the canon rulings *`ne` licenses a name atom*, *Productive Phi-form onyms*, *Letters*, and *Source material remains outside Phi*.

---

**Contents:**

1. Two kinds of Phi name
2. The announcing `ne`
3. Calling: `kona`
