...
(They were walking — as I read the signs.)
...
Translate aloud, choosing tense and aspect and nothing else — subject `lopia`, verb `wile` (play):

1. The child is playing (right now, mid-game).
2. The child plays (habitually — that is what recess is).
3. The child began to play.
4. The child had played (before the meal, complete).
