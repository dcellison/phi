...
The patient steps into subject position; the agent steps back, sayable in a prepositional phrase or honestly absent. Pamphlet 6 showed `se` doing its subtlest work inside relatives: `[rena se nila]`, the seen; `[rena se ma nila]`, the unseen. These build referents English needs fossilized participles for.
