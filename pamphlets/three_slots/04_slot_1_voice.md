...
The third rank answers one question: *who is doing this, and who set it in motion?* Two particles live here — the passive `se` and, since the July rulings, the causative `ka`, moved home from the modals because it does exactly what `se` does: it restructures who acts, and claims nothing about certainty or obligation.
...
The patient steps into subject position; the agent steps back, sayable in a prepositional phrase or honestly absent. Pamphlet 6 showed `se` doing its subtlest work inside relatives — `[rena se nila]`, the seen; `[rena se ma nila]`, the unseen — building referents English needs fossilized participles for.
