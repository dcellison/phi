...
mia ko lothea sano.
1SG FOC love know.
(It is love that I know — that, specifically.)

ko mia thia nila.
FOC 1SG 2SG see.
(*I* see you — I, not another.)
```
...
3. only this child
4. the dog too
5. these very large trees
6. only sulae — twice: once fenced, once merely pointed at.

Answers: 1 `ha lo shiro`. 2 `ra nu ta philo`. 3 `li ha lopia`. 4 `we lohau`. 5 `ha lo ru whalo shiro`. 6 `li ne sulae` — and `ko ne sulae`, and the difference between them is the difference between *no one else* and *her, is who* — a fence and a finger. If you paused before any ordering, say the cline once and rebuild: wider first, always.
