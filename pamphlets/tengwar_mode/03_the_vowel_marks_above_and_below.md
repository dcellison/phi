...
`melu` has two vowels and two consonants: m·e, l·u. Neither vowel gets its own letter. Each rides as a tehta — a small mark — above the consonant that opens its syllable: the e-tehta sits over malta, the u-tehta sits over lambë. Toggle the script above and you are looking at exactly that: two tengwar, two marks, nothing else, each vowel's own shape distinct from every other vowel's.

All five vowels — a, e, i, o, u — have an above form. None of them look like each other, and none of them look like the tehta a consonant carries for the *same* vowel in hiatus (chapter 4). Learn a vowel's above shape by toggling every worked example in this pamphlet, not by reading a description of it: a mark this small is easier to recognize than to describe.
