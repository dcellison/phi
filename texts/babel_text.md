...
*The complete Phi translation keeps the builders' fear, the tower, the loss of mutual understanding, and the worldwide dispersal. The LORD remains in the exact King James line; Phi describes the actor through `karami`, authority.*
...
| scattered abroad | scattered from the place across the earth | `thiwera` carries dispersal without judging it welcome; the authority frame supplies its punitive force. |
