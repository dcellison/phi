...
*This page gives the passage two Phi renderings. In the close translation, the builders still fear dispersal, and the LORD confounds their speech and scatters them abroad. The transmutation gives those acts to `muila`, the earth, and reads the same scattering as sowing. `haluma` names language, while the comparison with `thinoe`, seed, changes how the second `thiwera` is read.*
...
lo mueri kerou wei lo shia kerou to nai. theru nuko loesi wei lo shia whu lo mueri kerou lorea muralo to nai.
...
lo mueri kerou wei lo shia kerou to nai. muphia lo mueri kerou to lorea.
PL clay stone DAT PL 3SG stone PST be. mud PL clay stone PST connect.
