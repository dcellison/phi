...
Status: In progress. The primer, text, and manual shelves are complete. The workbook treatment now covers *The Three Slots* and the four clause-building companions; nine pamphlets and the shelf catalogue remain.
...
4. **Pamphlets:** Five workbooks complete. *The Three Slots* established the practice-book design from its opening through the appendix. Adverbial clauses, complementizers, coordination, and relative clauses form the second family, with a bracket-and-join mark suited to clauses that open, close, modify, and meet. The older complementizer files did not pretend to have been written yesterday. The renderer handles their plain page titles and deeper heading levels, then lowers the second `# Answer key` into the page hierarchy. Interlinear answer glosses receive their own line, and unusually wide structural diagrams scroll inside the example that owns them instead of widening the page. The strict manifest pins all 51 treated pages and their continued exercise numbering. Every treated page was loaded at desktop and phone widths, then once without the stylesheet: 153 renderings in all. Direct inspection covered both colour themes and print, plus the responsive table and answer-key layouts. The other nine pamphlets come next; the catalogue follows them.
