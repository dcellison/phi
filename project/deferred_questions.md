...
Status: In progress. The primer and text shelves are complete. The manual treatment now covers Parts I through III, with the approved Part IV prototype retained as the grammar reference.
...
3. **Manual:** In progress. All 39 pages in Parts I through III now use the working-reference treatment without changing their Markdown. First Light carries a sunrise-and-sprout mark, Soul a heart-and-sprout mark, and Phonology a voice-and-ear mark. The shared frame names the part, chapter, and page position, numbers substantial sections, and offers a local map when a page has more than one section. It also knows when to stand back: short introductions and unsectioned essays do not receive an empty map. The beginner road conversation has speaker rows, pronunciation tables become labelled records on phones, and the exercise sequence keeps its ten stops visible without turning practice into a dashboard. Structural signatures record the block shapes the renderer depends on, while the original Part IV descriptors-and-quantifiers prototype still pins its canonical noun-phrase pattern. Browser checks cover every treated page at desktop and phone widths, with representative dark and print checks. Continue with Parts IV through VI, then Part VII and the back matter, and finish with the manual contents and a whole-manual consistency pass.
