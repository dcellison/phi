...
Status: In progress. The primer and text shelves are complete. The manual prototype is ready for maintainer review.
...
3. **Manual:** The first prototype is `manual/part4_grammar/ch11_nouns/05_descriptors_and_quantifiers.md`, chosen because one page carries ordinary explanation, three tables, two interlinear examples, and the seven-place noun-phrase pattern. Its compact masthead names Part IV, Chapter 11, and the page's position within the chapter. A six-link map and numbered headings divide the reference work without dressing it as a magazine. Tables keep their columns on wide screens and become labelled records on phones; examples and the canonical pattern each have a quieter working form. The build pins the source title, headings, table shapes, examples, and pattern before applying the treatment, and the Markdown remains unchanged. Review this page before carrying the design through the manual.
