...
| ID | Concept | Status | Placement | Decision or return condition |
|---|---|---|---|---|
| `CV-PHIL-01` | emergence and correlation | Deferred | Philosophical Reasoning, Systems, or shared base | When the Systems and Shared Infrastructure prose migration examines system change, observation, and causal claims in connected use. The first philosophical pass named emergence, correlation, inference strength, and responsibility as later questions. This pass closes ordinary inference strength and responsibility composition separately; emergence and correlation remain concrete questions for connected Systems work. |
...
| `CV-PHIL-01` | emergence and correlation | Deferred | Philosophical Reasoning, Systems, or shared base | See the complete decision under [Reason, belief, ritual, and value](#reason-belief-ritual-and-value). |
