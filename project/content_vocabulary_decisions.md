...
| [Philosophical Reasoning module prose](#philosophical-reasoning-module-prose) | complete | closed | 12 |
| [Systems and Shared Infrastructure module prose](#systems-and-shared-infrastructure-module-prose) | complete | closed | 16 |
| [Ecological Systems and Material Life module prose](#ecological-systems-and-material-life-module-prose) | complete | closed | 15 |
| [Commons and Collective Governance module prose](#commons-and-collective-governance-module-prose) | complete | closed | 20 |
| [Household and Daily Life module prose](#household-and-daily-life-module-prose) | complete | closed | 26 |
...
| ID | Concept | Status | Placement | Decision or return condition |
|---|---|---|---|---|
| `CV-MEAS-01` | temperature, humidity, and illumination as measured parameters | Implemented | Ecological, Systems, Medical, and Accessibility learning paths according to meaning | Words: `sumeri`, `wimura`, `keruma`. `sumeri`, `wimura`, and `keruma` identify temperature, humidity, and illumination as conditions that can be compared or monitored. Everyday hot, wet, and bright qualities keep their felt meanings. Exact measurements and instrument records retain their source form. |
...
| `CV-SKY-02` | horizon, atmosphere, and humidity | Compositional | base roots and expressions, with an Ecological parameter noun | `waero norui`, `haowu`, `wirua haowu`, `wimura`. The visible sky has an apparent boundary, and ordinary atmosphere remains air around a place or world. `wirua haowu` describes wet air as a felt condition; implemented `wimura` names humidity as a parameter. Exact layers, values, units, and methods remain separately identified. |
...
| ID | Concept | Status | Placement | Decision or return condition |
|---|---|---|---|---|
| `CV-PHIL-01` | emergence and correlation | Implemented | Philosophical Reasoning, Systems, Ecological, and Medical learning paths according to meaning | Words: `harusi`, `hosari`. `harusi` names a whole-level pattern arising through component interaction, while `hosari` reports variables changing together without supplying a cause. The two relations now have stable module vocabulary instead of borrowing change, appearance, or sequence. |
...
| `CV-ENERGY-01` | electricity, electric charge and current, and related electrical phenomena | Implemented | Systems, Household, Ecological, and Work learning paths according to meaning | Words: `thewaki`, `rishonu`, `sephaki`. `thewaki` names electricity broadly, `rishonu` electric charge, and `sephaki` charge in motion. `thewaki kenua` identifies electrical energy, while supply adds a source, state, and available capacity. |
...
| `CV-PHIL-01` | emergence and correlation | Implemented | Philosophical Reasoning, Systems, Ecological, and Medical learning paths according to meaning | See the complete decision under [Reason, belief, ritual, and value](#reason-belief-ritual-and-value). |
| `CV-SYSTEMS-02` | feedforward control | Implemented | Systems and Shared Infrastructure | Words: `naropu`. `naropu` names control that acts from an observed or expected input before the resulting output returns. Prediction supplies the expectation; feedforward begins when that expectation changes control. |
...
|---|---|---|---|---|
| `CV-PHIL-01` | emergence and correlation | Implemented | Philosophical Reasoning, Systems, Ecological, and Medical learning paths according to meaning | See the complete decision under [Reason, belief, ritual, and value](#reason-belief-ritual-and-value). |
| `CV-PHIL-02` | hypothesis and alternative hypothesis | Implemented | Philosophical Reasoning, Systems, and Ecological Systems and Material Life | Words: `hoshemi`. The new noun gives a proposed explanation or relation a stable place under examination without turning it into a premise, evidence, or settled fact. Ordinary `phirae hoshemi` supplies an alternative hypothesis. |
| `CV-PHIL-03` | premise, proposition, assumption, and hypothesis | Compositional | base grammar with Philosophical Reasoning vocabulary | `sherewa`, `mothare`, `ho`, `hoshemi`. `sherewa` puts a proposition forward as a claim, `mothare` gives a proposition a starting role inside an argument, evidential `ho` marks assumption as a claimed source, and `hoshemi` names a proposed account under examination. The roles can overlap in one discussion without becoming synonyms. |
| `CV-PHIL-04` | sound arguments, invalidity, fallacies, and ordinary proof | Compositional | base reasoning words with Philosophical Reasoning | `kithela themore`, `shewo mothare`, `kithela ma`, `kanelu`, `whekate`. A sound argument states a `kithela themore` and true premises. Negated validity reports invalidity, `kanelu` identifies an error in the reasoning, and `whekate` records a successful refutation. Exact named fallacies and formal proofs retain the source boundary in `CV-EPIST-02`. |
| `CV-PHIL-05` | theory, explanatory framework, and model in ordinary discussion | Compositional | Philosophical Reasoning and Systems vocabulary | `solae`, `themore`, `hoshemi`, `reteru`, `terura`. A speaker can present an organised explanation through `solae`, state its supporting `themore`, place its hypotheses under examination, and use `reteru` when a bounded representation of a system is intended. These relations are clearer than one root that copies every English use of theory or framework. |
| `CV-PHIL-06` | exact named theories, doctrines, schools, philosophical terms, and source definitions | Source-bound | source tradition or work beside a Phi account | Keep the source name and wording with the definition, citation, and edition that fix the reference. Phi states the account under examination and separates the distinctions carried by a module word from those left with the source. Phi can explain a theory's claims, premises, concepts, consequences, and critics. Its exact name and inherited distinctions remain with the tradition or text that gives them identity. |
| `CV-PHIL-07` | interpretation, ambiguity, and competing readings | Compositional | base meaning and reasoning vocabulary | `reo`, `sherewa`, `kethira`, `lilea`, `solae`. A speaker can state what an expression `reo`, make a claim about that meaning, draw an inference from it, or use `lilea` when wording admits more than one reading. Competing interpretations become competing meaning claims with their evidence and context left visible. |
| `CV-PHIL-08` | ordinary inference strength and confidence in a conclusion | Compositional | base support relations with Philosophical Reasoning | `panoru`, `thesori`, `norethi`, `whamoi`. `panoru` says what supports a claim, while degree and competing evidence show how much support is present. `norethi` reports a person's confidence separately. Exact probabilities, odds, and formal standards retain their source record under `CV-EPIST-02`. |
| `CV-PHIL-09` | responsibility, accountability, obligation, and causal contribution | Compositional | base agency vocabulary with Commons and Work | `thonai`, `lothoni`, `naseru`, `ka`, `thueli`. `thonai` names responsibility for an act or role, `lothoni` names answerability before affected people or an agreed process, and `naseru` states obligation. Cause, authority, awareness, choice, and effect remain available as separate claims when responsibility is divided or disputed. |
| `CV-LOGIC-01` | necessary and sufficient conditions | Compositional | base criterion with Philosophical Reasoning entailment | `kirema`, `natheri`. `kirema` identifies the condition being applied, and the direction of `natheri` states whether the condition follows from membership or makes membership follow. Keeping the two propositions visible is more reliable than labels whose direction speakers routinely reverse. |
| `CV-EPIST-01` | proof and certainty in ordinary claims | Compositional | base reasoning words with Philosophical Reasoning where needed | See the complete decision under [Reason, belief, ritual, and value](#reason-belief-ritual-and-value). |
| `CV-EPIST-02` | formal proofs, exact probability values, odds, named inference methods, fallacies, and logical or epistemic standards | Source-bound | exact source material beside a Phi account | See the complete decision under [Reason, belief, ritual, and value](#reason-belief-ritual-and-value). |

## Systems and Shared Infrastructure module prose

| ID | Concept | Status | Placement | Decision or return condition |
|---|---|---|---|---|
| `CV-MEAS-01` | temperature, humidity, and illumination as measured parameters | Implemented | Ecological, Systems, Medical, and Accessibility learning paths according to meaning | See the complete decision under [Environmental and spatial qualities](#environmental-and-spatial-qualities). |
| `CV-MEAS-05` | mass as a scientific magnitude distinct from weight | Deferred | Systems or exact source material | See the complete decision under [Size, extent, and distance](#size-extent-and-distance). |
| `CV-PHIL-01` | emergence and correlation | Implemented | Philosophical Reasoning, Systems, Ecological, and Medical learning paths according to meaning | See the complete decision under [Reason, belief, ritual, and value](#reason-belief-ritual-and-value). |
| `CV-SYSTEMS-02` | feedforward control | Implemented | Systems and Shared Infrastructure | See the complete decision under [Recovered cross-inventory prompts](#recovered-cross-inventory-prompts). |
| `CV-ENERGY-01` | electricity, electric charge and current, and related electrical phenomena | Implemented | Systems, Household, Ecological, and Work learning paths according to meaning | See the complete decision under [Roles, places, relations, and remaining concrete nouns](#roles-places-relations-and-remaining-concrete-nouns). |
| `CV-ENERGY-02` | exact energy quantities, units, ratings, tariffs, products, grid identities, and equipment specifications | Source-bound | exact technical, billing, or equipment source beside a Phi account | See the complete decision under [Roles, places, relations, and remaining concrete nouns](#roles-places-relations-and-remaining-concrete-nouns). |
| `CV-ENERGY-03` | voltage as an electrical parameter distinct from its exact value | Implemented | Systems and Work learning paths | Words: `poweshi`. `poweshi` identifies electrical potential difference between two points, so a Phi account can name the parameter while its exact reading stays with the source. Current and power keep their own relations. |
| `CV-ENERGY-04` | technical power as the rate of energy transfer or conversion | Implemented | Systems, Household, Ecological, and Work learning paths | Words: `phoselu`. `phoselu` distinguishes the rate of energy transfer from energy itself. Political power remains a social relation outside this technical noun, and exact ratings stay with their source. |
| `CV-SYSTEMS-03` | variable as a named feature or quantity that may take different values | Implemented | Systems, Ecological, and Medical learning paths | Words: `wuneri`. `wuneri` gives a model, test, record, or control process a noun for the selected feature that may vary. Its exact value and symbol stay with the record; method and causal importance remain part of the analysis. |
| `CV-SYSTEMS-04` | sensor and actuator component roles | Compositional | Systems expressions | `somela monaki`, `ketora monaki`. An observation component and a control component state the role that matters. The surrounding account supplies its variable, signal, or affected process, while exact device identity stays with the source. |
| `CV-SYSTEMS-05` | setpoint, disturbance, and technical error | Compositional | Systems clauses and transparent expressions | `kanu mirela`, `lerua koewi`, `mothami nela mirela phirae`. A selected state, an outside input that changes the process, and the difference between a reference and observed state are three relations. Keeping their participants visible avoids one control label whose scope has to be guessed. |
| `CV-SYSTEMS-06` | service availability, throughput, frequency, and technical rate | Compositional | Systems state, output, cycle, and period expressions | `kelitho mirela`, `thirulo mosha`, `nuri mosha`. Function state reports availability, output across a stated period reports throughput, and cycles across a period report frequency. Exact values and units remain in source material rather than becoming hidden inside the expressions. |
| `CV-SYSTEMS-07` | exact standards, protocols, formulas, conversion rules, and versioned technical requirements | Source-bound | exact technical source beside a Systems account | Standards, protocols, formulas, conversion rules, versioned specifications, and named technical methods retain their source form. Phi describes where the artifact came from, how it applies, and what authority it carries in the present decision. Phi can identify the role of a technical artifact and discuss the relation it records. Exact notation, wording, identity, and version stay with the source that makes the result reproducible. |
| `CV-SYSTEMS-08` | further named electrical and process parameters such as resistance, capacitance, and pressure | Deferred | Systems, Work, Ecological, or exact source material according to connected use | When a connected systems, repair, or ecological passage repeatedly distinguishes one of these parameters from its value, instrument, source label, and neighbouring physical relation. Voltage and the generic variable relation now have Phi words, while exact values remain in their source notation. Further parameter nouns should enter as a coherent set when sustained technical use needs to compare the parameter itself rather than merely point to a labelled reading. |
| `CV-SYSTEMS-09` | infrastructure, service, electrical grid, and distribution network | Compositional | Systems expressions with Commons where governance matters | `sila panoru terura`, `panoru kelitho`, `thewaki sekaru phaliso`. Community-support system names infrastructure, support function identifies a service, and an electricity-transfer network identifies a grid. Commons vocabulary carries the social relations around each one. |
| `CV-NET-02` | exact network names, addresses, protocols, accounts, services, and identifiers | Source-bound | exact technical or service source beside a Phi network account | See the complete decision under [Roles, places, relations, and remaining concrete nouns](#roles-places-relations-and-remaining-concrete-nouns). |
...
| `CV-MEAS-01` | temperature, humidity, and illumination as measured parameters | Implemented | Ecological, Systems, Medical, and Accessibility learning paths according to meaning | See the complete decision under [Environmental and spatial qualities](#environmental-and-spatial-qualities). |
| `CV-MEAS-05` | mass as a scientific magnitude distinct from weight | Deferred | Systems or exact source material | See the complete decision under [Size, extent, and distance](#size-extent-and-distance). |
| `CV-WATER-02` | current, glacier, waterfall, groundwater, and wetland | Compositional | base expressions with an ecological-module term where needed | See the complete decision under [Landscape, waters, sky, and weather](#landscape-waters-sky-and-weather). |
| `CV-SKY-02` | horizon, atmosphere, and humidity | Compositional | base roots and expressions, with an Ecological parameter noun | See the complete decision under [Landscape, waters, sky, and weather](#landscape-waters-sky-and-weather). |
| `CV-LAND-03` | narrow geological and coastal landform classes | Deferred | base, ecological module, or exact source term according to use | See the complete decision under [Landscape, waters, sky, and weather](#landscape-waters-sky-and-weather). |
| `CV-SKY-03` | specialist astronomical and meteorological classes | Deferred | future module vocabulary plus exact scientific source material | See the complete decision under [Landscape, waters, sky, and weather](#landscape-waters-sky-and-weather). |
| `CV-ECO-01` | ecological niche, species range, and abundance | Compositional | Ecological relations and scoped observations | `menuro`, `kelitho`, `pherami`, `likori norui`, `liloni norui`, `lorua`. Habitat and function show one dimension of niche; dependency, resource, and interaction show others. Dwelling and boundary locate a range. Amount tied to place and time expresses abundance. One broad root would hide those choices. |
| `CV-ECO-02` | groundwater, wetland, upstream and downstream, and infiltration | Compositional | Ecological water, habitat, direction, and movement expressions | `muila phialu`, `wirua muila menuro`, `phialu selu`, `sekaru`, `phialu muo muila koema`. Earth-water, wet-land habitat, explicit flow direction, and water entering earth keep location and process visible. Exact aquifer, wetland, recharge, and legal classes remain available beside the Phi account when their source boundary matters. |
| `CV-ECO-03` | heatwave as heat excessive for a place and period | Compositional | Ecological climate and duration expression | `sharoi sukaro mosha`. `sharoi sukaro mosha` names a period of excessive heat. Place and duration set its scope; the climate reference and affected beings explain its significance. An exact threshold stays with its source instead of becoming one universal heatwave number. |
| `CV-ECO-04` | environmental emission and pollutant | Compositional | Ecological and Systems pathway expressions | `leiro thirulo`, `pesenu muralo`. A released output becomes an emission when its source, agent, amount, and destination are stated. A material becomes a pollutant through demonstrated pollution, not through unexpected presence or a purity judgement alone. |
| `CV-ECO-05` | organic matter, compost, and direct reuse | Compositional | Ecological material and process expressions | `shaemu muralo`, `thepalu morume muralo`, `turema koewi`. Living-derived material, managed decomposing garden material, and a returned input preserve three different material histories. Recycling keeps its separate transformation process. Exact compost grades and organic fractions retain their source terminology. |
| `CV-ECO-06` | food web and ecological carrying capacity | Compositional | Ecological network and conditioned-capacity expressions | `nuola phaliso`, `litero henora`, `menuro henora`. An eating network keeps organisms and feeding directions available to name. Ecosystem or habitat capacity requires a population, function, period, and conditions, so neither expression turns a diagram or number into a complete ecological limit. |
| `CV-ECO-07` | ecological indicator, forecast, and monitoring interval | Compositional | Ecological evidence and time expressions | `mirela siru`, `wireo mirela kethira`, `somethi mosha`. A state marker remains distinct from the condition inferred through it, a future-state inference remains answerable to evidence and a model, and a monitoring period keeps its duration audible. |
| `CV-ECO-08` | precaution, environmental justice, and authority over land or water | Compositional | Ecological, Commons, and Philosophical relations | `pemaru`, `karami`, `norulo`, `shereni`, `naseru`, `lothoni`, `helolu`. Precaution begins with possible hazard and uncertainty. It also states the protective action, its burden, room for refusal, and review. Commons terms carry authority and jurisdiction as well as entitlement and obligation. Accountability and redress keep environmental justice open without letting an ecological label settle legitimacy. |
| `CV-ECO-09` | exact ecological taxonomies, measurements, sites, methods, models, standards, legal classes, and attributed knowledge | Source-bound | ecological, scientific, legal, or community source beside a Phi analysis | Species and taxonomic names retain source form and attribution, as do chemical identities. Measurements keep their values, units, and methods; sites and samples keep identifiers and dates. Datasets, model identities, equations, and standards remain exact. Legal categories and knowledge-tradition terms stay with the sources that establish their authority, provenance, or restriction. A core or module paraphrase does not replace them when identity or contested history matters. Phi can name the ecological relation around an exact record and question how the record is used. Identity, method, and notation stay with the source. Provenance, authority, and restriction remain there because they make the claim recoverable. |

## Commons and Collective Governance module prose

| ID | Concept | Status | Placement | Decision or return condition |
|---|---|---|---|---|
| `CV-ACCESS-01` | legal or certified accessibility | Source-bound | Accessibility plus exact source material | See the complete decision under [Access, perception, and independent participation](#access-perception-and-independent-participation). |
...
| `CV-ECON-01` | money, prices, wages, debt, profit, taxation, budgets, and monetary accounting | Declined | no Phi lexical roots; exact source records remain available beside a Phi account | See the complete decision under [Reason, belief, ritual, and value](#reason-belief-ritual-and-value). |
| `CV-JUST-01` | exact laws, legal rights, offences, remedies, judgments, contracts, and institutional justice procedures | Source-bound | Commons vocabulary beside exact legal source material | See the complete decision under [Reason, belief, ritual, and value](#reason-belief-ritual-and-value). |
| `CV-RESOURCE-01` | resource, material, supply, stock, commons, asset, and waste classifications | Compositional | base resource vocabulary with established module terms | See the complete decision under [Roles, places, relations, and remaining concrete nouns](#roles-places-relations-and-remaining-concrete-nouns). |
...
| `CV-SECRET-01` | passwords, access credentials, security classifications, sealed records, and legally protected information | Source-bound | the access, security, legal, or institutional source that gives the information effect | See the complete decision under [Roles, places, relations, and remaining concrete nouns](#roles-places-relations-and-remaining-concrete-nouns). |
| `CV-SYSTEMS-09` | infrastructure, service, electrical grid, and distribution network | Compositional | Systems expressions with Commons where governance matters | See the complete decision under [Systems and Shared Infrastructure module prose](#systems-and-shared-infrastructure-module-prose). |
| `CV-ECO-08` | precaution, environmental justice, and authority over land or water | Compositional | Ecological, Commons, and Philosophical relations | See the complete decision under [Ecological Systems and Material Life module prose](#ecological-systems-and-material-life-module-prose). |
| `CV-COMMONS-01` | governance as a continuing collective arrangement | Implemented | Commons and Collective Governance learning path | Words: `kowanu`. `kowanu` names the continuing arrangement through which a group makes collective decisions, carries them into practice, and reviews them. It keeps governance available as a subject of discussion without turning one council or institution into the whole arrangement. |
| `CV-COMMONS-02` | petition as a formal request directed to a person or institution | Implemented | Commons and Collective Governance learning path | Words: `pashenu`. `pashenu` gives one person or a group a direct nonviolent action for presenting a formal request. The word stays apart from proposing an action for collective decision and appealing an earlier decision; exact wording and signatures remain with the petition record. |
| `CV-COMMONS-03` | affected party, constituency, and procedural standing | Compositional | Commons clauses naming effect, representation, and criteria | `ka`, `peloma`, `shalori`, `wemari`, `kirema`, `pawela`. A person becomes affected through the concrete action or burden that reaches them, not through institutional recognition. A constituency follows the people and matter a representation claim covers. Standing follows the criterion for taking part in one procedure. Those visible relations prevent any one label from silently granting or removing voice. |
| `CV-COMMONS-04` | residence, citizenship, offices, mandates, polities, governments, nations, democracy, and sovereignty | Source-bound | political or community source beside a Commons analysis | Residence and citizenship statuses retain their official or community form. Office titles and mandates do the same, together with terms, succession rules, or appointment records. Names for governments, states, nations, and peoples remain exact. So do polities, democracies, and sovereignty when identity, authority, or contested history depends on the category. Phi can describe dwelling, membership, roles, institutions, authority, jurisdiction, representation, and decision procedure. The named political category remains with its source because it carries a history and a claim about who belongs or may act. |
| `CV-COMMONS-05` | agenda, quorum, decision threshold, majority, minority, election, and referendum | Compositional | meeting records, criteria, counts, votes, and decisions | `sirami`, `repora`, `kirema`, `kasira`, `kanuro`, `theula`, `shelami`, `soli`. An agenda is the ordered record of matters intended for a meeting. A quorum or threshold joins a participation criterion to an exact count or rule. Quantifiers and source counts describe majority or minority results, while an election or referendum is a stated vote procedure and its resulting decision. The parts leave inclusion and weighting open to examination. |
| `CV-COMMONS-06` | laws, constitutions, policies, bylaws, regulations, treaties, contracts, and customary rules | Source-bound | exact legal, political, or community source beside generic `nasholu` rule analysis | The source keeps its category, title, identifier, and version together. Its operative wording stays with the parties and issuing authority. Constitutions, laws, policies, and bylaws remain outside Phi syntax when identity or force matters; regulations, treaties, contracts, and customary rules follow the same boundary. `nasholu` identifies the generic role of a social rule. The source category and wording stay exact because they determine parties, jurisdiction, interpretation, and force. A Phi paraphrase can discuss the rule without replacing the artifact people are relying on or contesting. |
| `CV-COMMONS-07` | public status, transparency, confidentiality, publication, and access to records | Compositional | Commons and Accessibility information relations | `sirelu`, `shanewi`, `sirami`, `kupela`, `mirewu`, `ruweli`, `pharune`, `pharomu`. Disclosure and notice answer different questions, as do records and secrecy. Privacy concerns the people involved; practical access concerns whether they can inspect and use the material. Publication names actual distribution rather than presumed availability. Exact confidentiality and public-record rules retain their source wording. |
| `CV-COMMONS-08` | implementation, compliance, violation, repeal, revocation, and replacement | Compositional | Commons action, rule, cessation, change, and record clauses | `phoa`, `nasholu heno`, `te`, `helaki`, `sirami`. Implementation is the concrete action that follows a decision. `nasholu heno` states compliance, and its negation states that a rule is unsatisfied without adding guilt or harm. Repeal and revocation end applicability under stated authority and time; replacement adds the matter that follows. `helaki` remains the narrower amendment of something that continues. |
| `CV-COMMONS-09` | investigation, finding, sanction, penalty, punishment, and enforcement method | Source-bound | exact institutional or legal source beside inquiry, evidence, enforcement, harm, and review clauses | Investigation names and formal findings retain their exact source form. The same holds for legal status, sanction, penalty, and punishment categories. Enforcement methods, orders, and judgments remain with that record. Phi describes who acted and under what claimed authority, then what happened to the affected person and which appeal or redress remains available. Phi can separate inquiry from evidence and a recorded conclusion. It can name enforcement or exclusion and then describe coercion, material transfer, or harm. Review remains another act. The formal finding or consequence keeps its source category so the analysis does not invent a universal vocabulary of punishment. |
| `CV-COMMONS-10` | corruption, institutional capture, domination, and abuse of office | Compositional | Commons power, benefit, harm, and accountability relations | `sithora`, `karami`, `peshu`, `pilora`, `pharomu`, `kawhera`, `whepelo`, `lothoni`. Role and authority identify the entrusted position. Deception or disproportionate benefit can show how it is used; exclusion, coercion, or retaliation shows who bears the effect. Concealed accountability belongs in the same account. These clauses make institutional harm criticisable without one moral label hiding its mechanism, while an exact source framework can remain beside them. |
| `CV-COMMONS-11` | cooperatives, federations, unions, mutual aid, public protest, strikes, and civil disobedience | Source-bound | exact institutional or movement tradition beside collective Phi action | Named institutional forms and movement identities retain their own names and attributed meanings. Organising traditions, protest forms, labour actions, and declarations stay with them. Community-specific mutual aid keeps its source as well. Phi can describe participants and purpose, the action and claimed authority, then risk, refusal, or response around them. Phi can describe cooperation and alliance, shared institutions and resources, or advocacy and objection. Collective refusal and work that ceases remain direct acts. These relations support nonviolent collective action without pretending that one generic label exhausts the history or commitments of a cooperative, union, protest, strike, or civil-disobedience tradition. |
...
| `CV-CULT-01` | pollination, pruning, weeding, and fertilising | Deferred | Ecological, Household, or Work | See the complete decision under [Life, growth, cultivation, and flourishing](#life-growth-cultivation-and-flourishing). |
| `CV-MAT-09` | paint, varnish, mortar, cement, plaster, asphalt, coal, charcoal, and related material products | Deferred | Household, Work, Systems, Ecological, or shared base according to connected use | See the complete decision under [Materials, substances, fibres, and fire](#materials-substances-fibres-and-fire). |
| `CV-DWELL-01` | ceiling, stairs, corridor, gate, fence, and chimney | Compositional | base compounds | See the complete decision under [Dwelling, vessels, food, clothing, and light](#dwelling-vessels-food-clothing-and-light). |
| `CV-DWELL-02` | installed cooking, cooling, washing, bathing, and sanitation appliances or fixtures | Deferred | Household, Systems, Built Environment, or exact source material according to use | See the complete decision under [Dwelling, vessels, food, clothing, and light](#dwelling-vessels-food-clothing-and-light). |
| `CV-DWELL-03` | additional portable, directional, or electrically powered light sources | Compositional | base words and descriptions with exact equipment records where needed | See the complete decision under [Dwelling, vessels, food, clothing, and light](#dwelling-vessels-food-clothing-and-light). |
| `CV-DWELL-04` | additional utensils, vessels, furnishings, and functional garment types | Deferred | Household, base, or another practical module according to connected use | See the complete decision under [Dwelling, vessels, food, clothing, and light](#dwelling-vessels-food-clothing-and-light). |
...
| `CV-TOOL-01` | additional hand tools, fasteners, powered tools, protective equipment, and calibration equipment | Deferred | Household, Work, Systems, Accessibility, base, or exact source material according to connected use | See the complete decision under [Tools, travel, and practical objects](#tools-travel-and-practical-objects). |
| `CV-MESH-01` | screens, filters, grids, and exact mesh classes beyond an ordinary net | Deferred | Household, Ecological, Systems, Work, or exact source material according to function | See the complete decision under [Tools, travel, and practical objects](#tools-travel-and-practical-objects). |
| `CV-ENERGY-01` | electricity, electric charge and current, and related electrical phenomena | Implemented | Systems, Household, Ecological, and Work learning paths according to meaning | See the complete decision under [Roles, places, relations, and remaining concrete nouns](#roles-places-relations-and-remaining-concrete-nouns). |
| `CV-RESOURCE-01` | resource, material, supply, stock, commons, asset, and waste classifications | Compositional | base resource vocabulary with established module terms | See the complete decision under [Roles, places, relations, and remaining concrete nouns](#roles-places-relations-and-remaining-concrete-nouns). |
| `CV-ENERGY-04` | technical power as the rate of energy transfer or conversion | Implemented | Systems, Household, Ecological, and Work learning paths | See the complete decision under [Systems and Shared Infrastructure module prose](#systems-and-shared-infrastructure-module-prose). |
| `CV-COMMONS-04` | residence, citizenship, offices, mandates, polities, governments, nations, democracy, and sovereignty | Source-bound | political or community source beside a Commons analysis | See the complete decision under [Commons and Collective Governance module prose](#commons-and-collective-governance-module-prose). |
| `CV-HOUSE-01` | household membership, co-residence, roommates, and domestic roles | Compositional | Household and Commons relations | `womuri`, `menui`, `wemari`, `sithora`, `nua`. `womuri` identifies the domestic unit, and `menui` states who dwells where. Membership and role enter only when people actually claim them. A roommate or co-resident can therefore be described through shared dwelling without turning proximity into kinship, authority, or assigned work. |
| `CV-HOUSE-02` | hospitality as a relation among guest, host, welcome, and care | Compositional | Household guest and welcome relations | `phemi`, `phemila`, `whelani`, `phemiru`, `loa`, `theama`, `mirewu`. `phemi` and `phemila` name the two temporary positions, while `whelani` says that an arrival is wanted. Food, shelter, privacy, and care remain concrete acts around them. The composition leaves each household or tradition free to decide what hospitality asks of either person. |
| `CV-HOUSE-03` | tidying, putting away, and household routine | Compositional | base placement, storage, cleanliness, and habitual-action clauses | `thinu`, `phelure`, `hiso ka kelu`, `ro`, `riporu`. Tidying is the work of putting particular things in their intended places, storing what waits for later, and cleaning what needs it. Phi states those changes directly. Habitual `ro` can show a household routine without turning every repeated domestic act into one opaque category. |
| `CV-HOUSE-04` | food storage, cooling, drying, salting, and preservation | Compositional | base preservation relations with Household containers and food conditions | `phelure`, `nelore`, `kurathi`, `neri`, `pelui`, `morisa`, `tapulo`, `tapuri`, `mukesi`. Storage says where food waits for retrieval; preservation attends to keeping its condition. Dryness and temperature can enter alongside salt and closure, while later spoilage remains observable. The same relations suit cellars and jars as readily as drying racks or cold stores. Powered refrigeration does not become the universal household answer. |
| `CV-HOUSE-05` | frying, roasting, steaming, stirring, kneading, serving, and other food preparation methods | Compositional | base and Household preparation verbs beside exact culinary sources | `pharelo`, `thilonu`, `napako`, `therapi`, `welotu`, `seluto`, `kuremi`, `kati`. General cooking and preparation already combine with a heat source or vessel. Liquid and movement can be stated when they matter; cutting, grinding, and material change stay visible too. `napako` and `therapi` keep baking and boiling direct where those physical methods recur. A named culinary method can retain its source identity when the tradition or exact technique matters. |
| `CV-HOUSE-06` | housework, chores, assignment, workload, drudgery, and domestic power | Compositional | Household, Work, Commons, Accessibility, and base relations | `riporu`, `rilowa`, `kelomi`, `naweri`, `ritako`, `rimawu`, `pilora`, `kawhera`, `whepelo`. A chore remains a concrete `riporu` task attached to the work itself. Washing and cooking remain distinct from cleaning, repair, or care. Assignment and acceptance stay separate, as do workload and drudgery. Coercion, exploitation, or retaliation can be named when domestic arrangements use power harmfully instead of hiding that relation inside a softer household word. |
| `CV-HOUSE-07` | exact sanitation, cleaning, food-safety, and domestic health instructions | Source-bound | exact health, product, infrastructure, or community source beside a Household account | Cleaning-product identities and warnings retain their source form. Sanitation designs and maintenance instructions do as well. Food-safety rules retain their contaminant limits, public-health authority, and clinical guidance. Phi can discuss the material path and observed condition around that record. Access, action, and response remain available without reconstructing the source from a household paraphrase. Phi can describe dirt and cleanliness, washing and soap, and the material path through a latrine. It can also name contamination, spoilage, or infection and the people affected. A threshold or prescribed procedure still depends on the authority and method that established it. |
| `CV-HOUSE-08` | household utilities, service accounts, meter records, and named appliances | Source-bound | exact service, billing, equipment, or technical source beside Household and Systems relations | Provider and service names retain their source form. Account identifiers and meter readings do too, alongside tariffs and bills. Equipment models keep their ratings, controls, and repair instructions. Phi can identify who uses or supplies the service and what stopped working. The burden and proposed response remain available around those exact records. Water and heat remain discussable in Phi, as do electricity and supply. Storage has its own relation. Service loss, faults, and repair can then be stated around the exact device or service identity. Source measurements and account records stay exact. |
| `CV-HOUSE-09` | addresses, residence status, tenancy, leases, rent, and domestic legal claims | Source-bound | exact place, legal, community, or economic source beside Household and Commons relations | Addresses retain their original script and formatting. Residence and tenancy categories remain exact beside leases and notices. Property records retain rent amounts, payment histories, and jurisdiction-specific rights. Phi can discuss consent and access around them, or coercion and burden. Appeal and redress remain available without replacing the operative wording. Phi can state who dwells in a place and who claims ownership or authority there. Obligations and memberships remain separate relations. They do not recreate an address or legal status, and Phi's refusal of monetary vocabulary leaves rent and payment records in their exact source form. |
