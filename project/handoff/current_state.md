...
| Shelf visual identities | In progress; primer and texts complete, manual prototype awaiting review | The text shelf ends with *News from Nowhere* treated as one 32-chapter book. Its current three chapters have a shared contents page, complete movement maps, 565 pinned source-and-Phi passages, separate reader memory, and responsive light, dark, and print layouts. The manual prototype is `manual/part4_grammar/ch11_nouns/05_descriptors_and_quantifiers.md`. Its pinned renderer treatment adds a Part IV and Chapter 11 masthead, six-link local map, numbered reference sections, responsive tables, interlinear examples, and a visible noun-phrase sequence without changing the Markdown. Browser checks cover desktop, phone, dark, and print layouts with no horizontal overflow. Review that page before extending the treatment through the manual, then begin the pamphlets. Keep current Phi inside English paragraphs visually consistent with the book's inline treatment. |
