...
| Shelf visual identities | In progress; primer, texts, manual, and all fourteen pamphlets complete | The pamphlet workbook frame now covers all 154 source pages. An abacus and rising scale identify Ternary Numerals. The renderer recognizes numeral-to-value correspondence and the bare recital as separate drill forms. Worked decomposition has its own panel. A dialogue dash in the Phi line stays inside its interlinear figure, while ten answer divisions keep the long solutions navigable. The source shapes and every non-default list start remain pinned. Rails contain no extractable text, motifs exist only in CSS, and simplified readers receive clean prose without the stylesheet. The browser matrix opens every pamphlet page at 1440px, at 390px, and without CSS: 462 loads. Dark and print received separate checks. Direct inspection covered both numerical drills and the long answer page. Calculation, scenario, error, and appendix forms were checked separately. Only the pamphlet shelf catalogue remains in this visual sequence. |
