...
| Shelf visual identities | In progress; primer and texts complete | The text shelf ends with *News from Nowhere* treated as one 32-chapter book. Its current three chapters have a shared contents page, complete movement maps, 565 pinned source-and-Phi passages, separate reader memory, and responsive light, dark, and print layouts. Continue with one representative manual page, then extend the chosen reference treatment before beginning the pamphlets. Keep current Phi inside English paragraphs visually consistent with the book's inline treatment. |
