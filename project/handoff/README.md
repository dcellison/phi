...
No work is commissioned. The questions awaiting the maintainer are the book's title (the leading candidate remains *A Language You Cannot Hurry*), a possible uniform restyle of the bibliography's two inherited citation styles, and revision as the whole book is read together.
