...
The immediate task is the next SEM-09D literary pass in [`texts/ring_verse_refusal.md`](../../texts/ring_verse_refusal.md). Preserve its central refusal: the Ring's coercion and imposed binding must not soften into guidance or mutual bond. *The Velveteen Rabbit* follows, while *News from Nowhere* chapters 1-3 remain last. Change a passage only when current vocabulary makes it more faithful or natural. A transparent composition is not obsolete merely because a direct word now exists.
