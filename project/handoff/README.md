...
The immediate task is the next SEM-09D literary pass in [`texts/velveteen_rabbit.md`](../../texts/velveteen_rabbit.md). Its complete 430-unit transmutation may use any optional module word that earns its place, but later vocabulary must not erase the story's care, material change, illness, loss, or the Child's agency. *News from Nowhere* chapters 1-3 remain last. Change a passage only when current vocabulary makes it more faithful or natural. A transparent composition is not obsolete merely because a direct word now exists.
