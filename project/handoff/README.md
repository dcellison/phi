...
The immediate task is the book's cold open, [`book/00_the_boatman.md`](../../book/00_the_boatman.md). Inspect its active Phi in the argument and teaching context that surrounds it. Preserve the chapter's voice, source citations, and validated examples; English prose does not reopen merely because lexicon prose changed. Optional vocabulary belongs where the subject genuinely needs it, while a core paraphrase may remain the better teaching choice. Change a passage only when the present lexicon makes it more faithful or natural. A transparent composition is not obsolete merely because a direct word exists.
