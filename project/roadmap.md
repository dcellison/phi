...
| SEM-09D | **IN PROGRESS** | Retrofit active Phi passages after the full vocabulary-prose migration. | Fifteen literary retrofits complete the shelf, the drafted Phi book is current, and all nine manual Part I files have been reviewed without adding a root | Continue at manual Part II, then work through the remaining manual, primer, pamphlets, and current documents. |
...
3. The literary shelf, drafted book, and manual Part I are current. Continue at manual Part II, then inspect active Phi in the rest of the manual, primer, pamphlets, and current documents. Replace an older workaround only when the completed vocabulary improves fidelity or naturalness in that exact passage.
