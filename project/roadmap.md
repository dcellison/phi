...
| PUB-06 | **IN PROGRESS** | Give each website shelf a renderer-led visual identity while keeping its Markdown clean. | The renderer gives the book and whole primer distinct identities without changing their source; the primer includes all twenty-four lessons, its pronunciation prelude, contents ladder, and capstone. | Prototype the texts shelf next, then continue through the manual and pamphlets. Keep the book's inline treatment for current Phi inside English paragraphs as a shared convention. |
