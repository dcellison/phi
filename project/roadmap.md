...
| PUB-07 | **PARTIAL** | Give Kia, the Short Road, and the Phi Book contents page distinct entrance treatments without decorating their Markdown. | Kia now has its light threshold. Its Romanized and Tengwar greetings frame six numbered encounters and seven linked destinations, each open across its full row. The renderer checks the expected source shape, and the layout holds in light, dark, print, phone, and stylesheet-free reading. | Style the Short Road as a continuous walk, then make the Phi Book contents page a stronger entrance to the completed argument. |
