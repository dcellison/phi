...
3. The literary shelf, drafted book, and manual Parts I through V are current. Continue at manual Part VI, then inspect active Phi in the rest of the manual, primer, pamphlets, and current documents. Replace an older workaround only when the completed vocabulary improves fidelity or naturalness in that exact passage.
