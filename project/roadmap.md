...
| Isolated translation certification | **PARTIAL** | D102 governs the two one-way phases, D103 and D105 certify the first two works, and the generated [certification ledger](../documents/evaluation/translation_process_status.md) owns the exact complete queue and current counts. |
