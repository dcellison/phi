...
| Evidence-led semantic growth | **PARTIAL** | All eight active profiles have completed first vocabulary passes, every recovered content-vocabulary question has an explicit decision, and all 1,294 lexicon entries follow the target prose contract. The legacy corpus retrofit is complete, while the stricter paired-text fidelity sweep is current through The Velveteen Rabbit. The Metta Sutta repair adds integrity, virtue, pleasure, and craving under D068; Article 1 adds reason as a faculty under D069; Babel adds Work `torali` tower under D070; The Little Prince and Ring Verse repairs use existing vocabulary under D071 and D072; The Velveteen Rabbit adds base `tinemu` ant under D073. |
...
| SEM-07C | **DONE** | First commons and collective governance vocabulary expansion. | The original 27 module words, three base words, and D048 additions for governance and petition; retained compositions, generated index, and Part VII teaching chapter | Use the module in original governance and institutional writing and revise any term or composition that feels inadequate. |
| SEM-07D | **DONE** | First work, craft, and repair vocabulary expansion. | 28 Work, Craft, and Repair module words, two base words established with the pass, later source-led `torali` tower, retained compositions and source boundaries, generated index, and Part VII teaching chapter | Use the module in original work, learning, repair, and labor writing and revise any term or composition that feels inadequate. |
