...
| PUB-07 | **PARTIAL** | Give Kia, the Short Road, and the Phi Book contents page distinct entrance treatments without decorating their Markdown. | Kia has its light threshold. Its Romanized and Tengwar greetings frame six numbered encounters and seven linked destinations, each open across its full row. The Short Road is a twelve-stop walk with a compact map, joined waypoints, thirteen interlinear figures, and a closing invitation in both writing systems. Both renderers check their expected source shapes, and both layouts hold in light, dark, print, phone, and stylesheet-free reading. | Make the Phi Book contents page a stronger entrance to the completed argument. |
