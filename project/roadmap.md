...
| SEM-09A | **NEXT** | Apply a semantic coverage gate to content prose batches and resolve the retrospective review queue. | `project/content_vocabulary_coverage.md` audits the six completed base content groups; D020 and four target-shaped entries establish damage, wear, weakness, and rigidity in base vocabulary. | Test adhesion, traction, material phase, and neutral measurement in practical scenarios; record each decision, then resume inherited content prose migration with the gate in place. |
