...
Before creating or revising any text for Phi, read `documents/reference/voice_for_models.md` in full and load the installed Humanizer skill. The voice guide sets Phi's register and mechanics. Humanizer then gives every generated passage a separate editing pass.
