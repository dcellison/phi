...
```
pronouns:     mia
prepositions: lao nea lia mae pei neo
```

## two-syllable two-letter words
```
...
used:
```
interjections: ae ai ao ea ei eo ia ie io
```

## one-syllable three-letter words
```
pha phe phi pho phu
pla ple pli plo plu
sha she shi sho shu
...
used:
```
particles pos:   si na te lo ne
particles tense: li ta se wo lu ni
```
