...
class TestPolitenessContext(unittest.TestCase):
    ...
    def test_politeness_with_questions_appropriate(self):
        ...
        # Polite wh-question (now allowed!)
        result = self._validate_sentence("so wulime thi ta shola")
        self.assertTrue(result['is_valid'], "Polite wh-question should be valid")
        
        # Invalid: wa + wh-question combination
        result = self._validate_sentence("wa wulime thi ta shola")
        self.assertFalse(result['is_valid'], "wa + wh-question should be invalid")
        errors = self._get_errors_of_type(result, SentenceError.QUESTION_CONTEXT_MISMATCH)
        self.assertTrue(len(errors) > 0, "Should flag wa + wh-question as invalid")
    ...
    def test_politeness_with_formal_vocabulary(self):
        ...
        result = self._validate_sentence("so mia na wushia ta shola")
    ...
    def test_politeness_inappropriate_emotional_context(self):
        ...
        result = self._validate_sentence("so mia ma na thi whomo")
    ...
    def test_politeness_inappropriate_urgent_context(self):
        ...
        # Urgent command
        result = self._validate_sentence("so harote to shola")
        errors = self._get_errors_of_type(result, SentenceError.POLITENESS_CONTEXT_MISMATCH)
    ...
    def test_politeness_with_inference(self):
        ...
        result = self._validate_sentence("ro so mia na whethui mipho whemo")
    ...
    def test_formal_register_consistency(self):
        ...
        result = self._validate_sentence("so si thephoa na phuthui ta whupi")
    ...
    def test_register_conflict_formal_casual(self):
        ...
        result = self._validate_sentence("so mia nuthui whuwa")
    ...
    def test_institutional_register_consistency(self):
        ...
        result = self._validate_sentence("so na wushia mia ta shola")
    ...
    def test_politeness_showing_deference(self):
        ...
        result = self._validate_sentence("so mia na whethui mipho whemo")
    ...
    def test_politeness_formal_institutional_marking(self):
        ...
        result = self._validate_sentence("so na wushia thi ta shola")
    ...
    def test_politeness_softening_requests(self):
        ...
        # Softened request
        result = self._validate_sentence("wa so thi na whethea shire")
        self.assertTrue(result['is_valid'], "Politeness should soften requests")
        
        # Softened command
        result = self._validate_sentence("so na luthia to whupi")
    ...
    def test_power_relationship_contexts(self):
        ...
        result = self._validate_sentence("so na phuthui to whupi")
    ...
    def test_social_distance_contexts(self):
        ...
        result = self._validate_sentence("so mia na luthea whomo")
    ...
    def test_cultural_sensitivity_contexts(self):
        ...
        result = self._validate_sentence("so mia na thi misha whemo")
    ...
    def test_complex_politeness_evidentiality_formal(self):
        ...
        result = self._validate_sentence("hi so si thephoa na phuthui ta whupi")
        self.assertTrue(result['is_valid'], "Complex formal combination should be valid")
        
        # Inference + politeness + institutional context
        result = self._validate_sentence("ro so na wushia mia ta shola")
    ...
    def test_politeness_with_multiple_particles(self):
        ...
        result = self._validate_sentence("so si thephoa ma na phuthui ta whupi")
    ...
    def test_inappropriate_politeness_combinations(self):
        ...
        result = self._validate_sentence("so harote to ma sheho")
        errors = self._get_errors_of_type(result, SentenceError.POLITENESS_CONTEXT_MISMATCH)
    ...
    def test_register_transition_validation(self):
        ...
        result = self._validate_sentence("so mia na phuthui whuwa")
    ...
    def test_evidentiality_with_wh_questions(self):
        """Test that evidentiality particles can be used with wh-questions."""
        # Direct evidence + wh-question
        result = self._validate_sentence("hi wulime thi li shola")
        self.assertTrue(result['is_valid'], "Evidentiality + wh-question should be valid")
        
        # Inference + wh-question
        result = self._validate_sentence("ro hamite thi ta shola")
        self.assertTrue(result['is_valid'], "Inference + wh-question should be valid")
        
        # Hearsay + wh-question
        result = self._validate_sentence("nu timane sha su whema")
        self.assertTrue(result['is_valid'], "Hearsay + wh-question should be valid")
    
    def test_multiple_particles_with_wh_questions(self):
        """Test that multiple non-wa particles can be used with wh-questions."""
        # Evidentiality + politeness + wh-question
        result = self._validate_sentence("hi so wulime thi ta shola")
        self.assertTrue(result['is_valid'], "Evidentiality + politeness + wh-question should be valid")
        
        # Hearsay + politeness + wh-question
        result = self._validate_sentence("nu so hamite thi ta shola")
        self.assertTrue(result['is_valid'], "Hearsay + politeness + wh-question should be valid")
