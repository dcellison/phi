...
Three to nine people (`shao` to `phoi`, the community-sized numbers the ternary system was built around). A circle can do what pairs cannot: recite together (the metta refrain was made for unison), transmute together (chapter 24's exercises run beautifully as a table conversation), and disagree together, which is where the language's peace machinery finally gets real practice.
