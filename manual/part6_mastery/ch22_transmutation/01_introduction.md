...
The text shelf names the method used for each work. Its translations range from fables and declarations to sacred writing. Four teachings from *The Prophet* and three passages from *The Little Prince* join them. So does Williams's complete *The Velveteen Rabbit*. Each claim in those sources remains answerable to the Phi. The Ring Verse refusal and *News from Nowhere* are transmutations. Their changes are part of the work rather than defects hidden behind a source citation.
