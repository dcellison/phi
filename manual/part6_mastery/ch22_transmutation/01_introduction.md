...
The text shelf names the method used for each rendering. The Metta Sutta, *lothea thole*, is a close translation: each claim in its chosen English source remains answerable to the Phi. *The North Wind and the Sun*, Schleicher's fable, and UDHR Article 1 each place a close translation before a transmutation, so the two promises can be compared within one work. The other adapted works are transmutations. Their changes are part of the work rather than defects hidden behind a source citation.
