...
The text shelf names the method used for each rendering. The Metta Sutta, the Solarpunk Manifesto, and four teachings from *The Prophet* are close translations: each claim in the chosen source remains answerable to the Phi. *The North Wind and the Sun*, Schleicher's fable, and UDHR Article 1 set a close translation before a transmutation. The Babel story, the Heart Sutra, and five Tao chapters extend that arrangement across longer sources. In each case the two promises can be compared within one work. The remaining adapted works are transmutations. Their changes are part of the work rather than defects hidden behind a source citation.
