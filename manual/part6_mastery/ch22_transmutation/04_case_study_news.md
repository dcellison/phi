...
- The dollar figure does not survive at all. Phi has no money vocabulary. Hold that thought.
...
community PL home repair.
(The community repairs the homes.)
```

Notice the last sentence drops `ti`. The first three are received knowledge; the fourth is presented as what the village can see. In Phi, a report and a witness are grammatically different sentences. The exact source figures remain separately visible because translating them into ternary does not establish that the report is correct or complete.
