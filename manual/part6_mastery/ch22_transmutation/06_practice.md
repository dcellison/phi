...
The method only becomes yours by doing. These exercises rise in difficulty; each targets a specific skill from the case studies. Work with the lexicon open, the compound registry from Part VII beside it, and no shame in sitting with a sentence for a long time. The sitting is the practice.
