...
\begin{table}[H]
  \caption{\label{tab:orthography-consonants}Consonants}
  ...
  \end{tabular}
\end{table}
\subsection{Consonant Blends}
\begin{table}[H]
  \caption{\label{tab:orthography-blends}Consonant blends}
  \renewcommand\arraystretch{2}
  \setlength\extrarowheight{-2pt}
  \begin{tabular}{|c|c|l|}
    \hline \rowcolor{greyhead}
...
\subsection{Vowels}
\begin{table}[H]
  \caption{\label{tab:orthography-vowels}Vowels}
  \renewcommand\arraystretch{2}
  \setlength\extrarowheight{-2pt}
  \begin{tabular}{|c|c|l|}
    \hline \rowcolor{greyhead}
  ...
  \end{tabular}
\end{table}
\subsection{Vowel Diphthongs}
\begin{table}[H]
  \caption{\label{tab:orthography-diphthongs}Vowel diphthongs}
  \renewcommand\arraystretch{2}
  \setlength\extrarowheight{-2pt}
  \begin{tabular}{|c|c|l|}
    \hline \rowcolor{greyhead}
