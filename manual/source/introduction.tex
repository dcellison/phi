...
As mentioned, there is also an emphasis on simplicity in the language. Phi has
many aspects of a pidgin language without having been derived from existing
languages. An a priori pidgin is definitely a contradiction in terms, but the
resemblance to a pidgin is intentional. Wikipedia describes some of the common
traits of a pidgin language.%
