...
\begin{quote}
  \emph{\hspace{-0.8em} “the golden ratio, an irrational number with a value of approximately 1.618033988 which expresses the relationship that the sum of two quantities is to the larger quantity as the larger is to the smaller.”} - Wiktionary \footnote{\url{https://en.wiktionary.org/wiki/\%CF\%86}}
\end{quote}
