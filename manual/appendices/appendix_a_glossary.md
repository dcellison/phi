...
**translation**: Carrying a source's claims and distinctions into natural Phi while preserving its important images, relationships, and force. Translation follows the source without copying its word order. The shelf shows the method at full length in the Metta Sutta, two familiar fables, sacred texts, and political writing.
