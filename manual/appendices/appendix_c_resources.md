...
The manual is the teaching path. These are the other places the language keeps its work, and any of them can be read on its own.

| Where | What it gives you |
|---|---|
| The lexicon | Every word, searchable, with its sounds, its senses, and its Tengwar hand |
| The primer | A graded first course that teaches by reading one household's days |
...
- On numeral systems: WALS documents decimal, vigesimal, mixed, other-base, body-part, and restricted systems. Language-specific work on restricted numeral lexicons requires careful interpretation and does not license claims about a community's cognitive capacity or values.
