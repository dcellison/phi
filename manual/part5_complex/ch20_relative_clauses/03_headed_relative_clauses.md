...
```
whu lopia thumela miona ha nai.
...
```
whu nia tomora nai womu mioru nai.
...
```
whu mia to nila miona ha nai.
REL 1SG PST see person PROX be.
(The person whom I saw is here.)
```

The complete phrase **whu mia to nila miona** is the subject of **ha nai**.

### As object

```
mia whu shia to kealo nophi theo.
1SG REL 3SG PST create story read.
(I read the story that they created.)
```

The complete phrase **whu shia to kealo nophi** is the object of **theo**.

### Inside a prepositional phrase

```
mia nia whu mua shelira nai ruela thalo.
...
```
mia whu mia mua to thalo shelira lothea.
...
```
mia whu mia mua serao shelira to thalo ruela lothea.
1SG REL 1SG LOC old forest PST walk path love.
(I love the path that I walked in the old forest.)
```

```
whu shia wei lopia mioru nophi to shane miona ha nai.
...
```
mia whu mia to nila serao mioru shelu lothea.
