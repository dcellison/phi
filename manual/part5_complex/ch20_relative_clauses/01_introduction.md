...
English usually puts the description after its noun. Phi puts the relative clause first and opens it with **whu**.
...
```
whu mia to nila peloru mioru nai.
REL 1SG PST see flower beautiful be.
(The flower that I saw is beautiful.)
```

Inside the subject phrase, **mia to nila** means "I saw" with an object left unspoken. **whu** marks that gap as a description, and **peloru** supplies the missing object as the head noun. The complete phrase **whu mia to nila peloru** is the subject of **nai**.
