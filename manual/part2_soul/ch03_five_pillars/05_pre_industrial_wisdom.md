...
The color system is the clearest example. Phi rejects abstract "primary colors" from Western scientific tradition. Instead, it builds color around natural prototypes: sun-color, blood-color, living-thing-color, water-color, earth-color. A yellow flower doesn't match a specific wavelength; it has the quality of sunlight.

This extends beyond color. The word for home, `womu`, builds from welcoming embrace meeting grounded rest. The word for earth, `muila`, builds from deep groundedness through life emerging into fertility flowing. Abstract concepts remain anchored in physical experience.
