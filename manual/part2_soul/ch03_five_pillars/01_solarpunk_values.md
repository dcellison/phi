...
Solarpunk is a broad movement as well as an aesthetic. Its writers and makers do not share one programme, but many of them place the same bet against cynicism: what if we get it right? Phi takes that constructive orientation as a pillar. Nobody builds a future they have refused to imagine, and imagining one in working detail gives the hands somewhere to begin.
...
The "punk" in solarpunk resists arrangements that seal decisions away from the people and places living with them. It wants power, political and electrical alike, kept near the people it affects. A neighbourhood garden, a shared workshop, or a local assembly can put knowledge and choice close together. Larger systems remain necessary, especially where water, climate, transport, or care crosses local boundaries. The point is answerability, not smallness for its own sake.
...
The same care applies to tools and energy. `tenoa` is any object used as an implement for a task; the noun names the use and leaves the arrangements around it to the sentence. `sileta kenua` (solar energy) keeps the sun audible as the source. Ownership, access, and the condition of the equipment belong in the next sentences.

Solarpunk's recurring picture is the skilled hand beside the open panel, not the sealed box. It gives Phi a practical question to carry: can the person beside the system understand enough of it to take part in what happens next?
