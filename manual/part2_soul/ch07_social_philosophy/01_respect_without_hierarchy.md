...
Phi's evidential system reinforces this. When speakers can distinguish what they witnessed (`hi`), what they inferred (`ke`), what they heard secondhand (`ti`), and what they merely assume (`ho`), dogmatic assertion becomes structurally awkward. Intellectual humility gets built into the conversation, creating space for multiple viewpoints without anyone needing to dominate.
