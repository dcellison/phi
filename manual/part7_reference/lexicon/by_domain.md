...
| `riporu` | task | a selected scope for planning and status description |
...
| `mirewu` | private | a personal or shared boundary respected by others |
...
| `phelure` | store | holding something across time for later use |
