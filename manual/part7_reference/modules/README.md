...
|---|---|---:|---:|---|
| Philosophical Reasoning | [Philosophical Reasoning](philosophical_reasoning.md) | 21 | 22 | `sherewa` claim, `thesori` evidence, `remotha` reason, `kirema` criterion |
| Systems and Shared Infrastructure | [Systems and Shared Infrastructure](systems_and_shared_infrastructure.md) | 24 | 38 | `phelure` store |
| Ecological Systems and Material Life | [Ecological Systems and Material Life](ecological_systems_and_material_life.md) | 27 | 47 | `howenu` weather, `muralo` material, `panuri` resource |
...
| Household and Daily Life | [Household and Daily Life](household_and_daily_life.md) | 30 | 42 | `mirewu` private |
