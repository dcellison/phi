...
- *no* signals a request or command
- *lu* signals a conditional ("if...")
- *su* signals a wish or hope
- *pi* signals politeness
...
**Pi wa thia so lo melu nila?**  
*POL Q 2SG FUT PL friend see*  
"Could you please see the friends?"

Breaking this down:
- Slot 0: *pi* (politeness) + *wa* (question)
- Subject: *thia* (you)
- Slot 1: *so* (future)
- Slot 2 + noun: *lo melu* (plural friend)
- Verb: *nila* (see)
