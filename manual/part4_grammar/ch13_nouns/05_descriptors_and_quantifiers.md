...
|----------|---------|---------|
| `ha` | this, near speaker | `ha shelu` (this book) |
| `ra` | that, away from speaker | `ra thepalu` (that garden) |
...
- When the question is "what kind?", adjectives characterize the noun's qualities.
