...
The particle does not encode a numerical probability or a particular level of confidence. A speaker may hold an assumption lightly or stubbornly; **ho** says where the claim begins.

## Assumption and inference

**ke** starts from signs in this case. **ho** starts from a general expectation:

**shia to ke wepu.** — I infer they left because their coat and basket are gone.

**shia to ho wepu.** — I assume they left because they usually leave by now.

Both clauses assert a past departure and may be wrong. The evidence available for the first and the expectation behind the second are different things to examine.

## Assumption and possibility

**ho** names source; **po** marks the event as possible:

**pheralu ho lepa.** — I assume rain is falling.
