...
And Phi is not a thought experiment on paper. The lexicon holds over nine hundred words, each carrying its own reasoning, and the language has a shelf of literature: the Metta Sutta (*lothea thole*, the Practice of Love), Aesop's *North Wind and the Sun*, the Heart Sutra, chapters of the Tao Te Ching, *The Velveteen Rabbit* entire, and more. The fable ends with two results: `moli nela phena haolu welao lureko thola`, gentleness and kind speech bring good fruit; `keloa haolu nela kawhera pholeni thola`, rough speech and coercion bring departure. Part VII is your map to the whole shelf.

Phi carries source texts in two ways. A close translation protects the source's claims while giving them natural Phi grammar. A *transmutation* lets the language reshape the source according to its own distinctions and commitments, then shows the reader what changed. Part VI teaches that second practice; Part VII labels both methods on the text shelf.
