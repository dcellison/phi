...
### Language as implicit philosophy
...
### Cross-linguistic alternatives

This feels natural to English speakers, but it's not universal. It's one architecture among thousands.

In Tagalog and other Philippine languages, grammar often centers not on who does the action but on what's affected by it. The sentence gets restructured around the ball, not the thrower, something closer to "The ball underwent throwing by me." In Navajo, verbs encode the shape and movement qualities of objects, so the grammar itself pays attention to how the ball moves through space. Japanese and Korean place the verb at the end, so you can't know what happened until the sentence finishes.
