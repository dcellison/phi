...
| Teaching and learning | `thumela` teach, `shonela` learn, `moloi` apprentice, `thunai` student, `thole` practice, `solae` explain, `somela` observe, `shelomu` understand, `lilea` clarify | Learning can be described as explanation, observation, practice, and understanding. The roots do not conventionalize skill level, expertise, qualification, demonstration, assessment, certification, trainer duty, or authorization to use a tool. |
