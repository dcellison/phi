...
| Skill and qualification | skill, expertise, novice, qualified, certified, authorized, competent for a specific action | State knowledge of method, prior practice, observed demonstration, and current practical possibility; preserve exact credentials and source standards outside the Phi passage. |
...
| Economic relation | wage, payment, price, compensation, contract, employment, ownership, debt, profit | Keep exact source terms outside the Phi passage and describe concrete transfers or commitments in Phi until civic and economic scenarios establish which relations require shared lexical treatment. |
...
| State a safety condition | Name danger, safety, pain, rest, careful action, and the prohibited or delayed act; keep the exact source instruction or standard outside the Phi passage. | Exact wording does not establish access, understanding, applicability, competence, enforcement, or safe completion. |
