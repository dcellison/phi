...
| Urgency and public health | emergency, triage, transmission, isolation, population-level risk; reuse `perawi` for exposure and `kanuwhera` for coercion where their definitions fit | A non-prescriptive public-health scenario that separates individual care, community protection, evidence, authority, and coercion. |
