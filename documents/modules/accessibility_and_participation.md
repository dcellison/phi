...
| Timing and cognitive access | advance notice, processing time, predictable sequence, break, postponement, decision deadline | Repeated cases where `phoe`, `hasi`, `therilu`, and `thilonu` fail to distinguish the relevant timing relation. |
| Support and authority | accommodation, assistance, decision support, interpreter role, proxy, representation, delegated authority | Independent cases contrasting help, faithful interpretation, speaking for someone, and deciding for someone. |
| Participation and governance | consultation, asynchronous contribution, exclusion, decision hold, participation without presence, authority to close a decision | Collective decisions with several contributors and no assumption that presence or majority agreement settles access. |
