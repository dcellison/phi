...
Philosophical Reasoning established the implementation pattern, followed by Systems and Shared Infrastructure, Ecological Systems and Material Life, Commons and Collective Governance, Work, Craft, and Repair, and Medical and Bodily Care: canonical JSON entries with validated module membership, a generated by-module index, and a curated Part VII chapter. Medical also demonstrates that a profile pass may add a broadly necessary word such as `lesawi` consent to shared core rather than hiding it inside optional vocabulary. The other active profiles may follow the same pattern when their vocabulary passes begin; their existing scenarios remain useful sources of ideas and examples rather than admission gates.
