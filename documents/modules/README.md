...
| [Medical and Bodily Care](medical_and_bodily_care.md) | **Established vocabulary module** | 30 | 50 | `lesawi` consent | Symptoms, findings, health conditions, clinical evaluation, intervention effects, illness course, transmission, and public health. |
| [Systems and Shared Infrastructure](systems_and_shared_infrastructure.md) | **Established vocabulary module** | 33 | 47 | `phelure` store | System structure, inputs and outputs, electricity, control, feedback, technical state, upkeep, reliability, hazards, and specifications. |
...
| [Ecological Systems and Material Life](ecological_systems_and_material_life.md) | **Established vocabulary module** | 27 | 52 | `howenu` weather, `muralo` material, `panuri` resource | Ecological organization, land and water processes, weather and climate, pollution and exposure, material afterlives, energy, and repeated ecological observation. |
