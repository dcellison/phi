...
| [Work, Craft, and Repair](work_craft_and_repair.md) | **Established vocabulary module** | 28 | 73 | `winora` plan, `hasoru` pending | Work units and status, coordination, skill and qualification, training and evaluation, labor conditions, reward, design, built forms, electrical work, and material traceability. |
