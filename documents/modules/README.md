...
The [Module overlap assessment](module_overlap_assessment.md) accounts for the 227 roots established during the eight original vocabulary passes. Seventy-seven of those have shared membership, 137 keep one module, and thirteen belong in base vocabulary. The [Base vocabulary placement assessment](base_vocabulary_placement_assessment.md) then checks the other 819 content roots and classifies thirty older roots where their lexical center is specialized. Later connected reviews added `hoshemi` hypothesis, nine Systems roots, three Ecological parameter nouns, Commons `kowanu` governance and `pashenu` petition, the Metta Sutta distinctions `serathi`, `taleri`, and `wurashi`, Philosophical `remori` reason, and Work `torali` tower. The current optional layer contains 266 roots and 400 memberships.
