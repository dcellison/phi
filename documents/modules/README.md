...
The [Module overlap assessment](module_overlap_assessment.md) accounts for the 227 roots established during the eight vocabulary passes. Seventy-seven of those have shared membership, 137 keep one module, and thirteen belong in base vocabulary. The [Base vocabulary placement assessment](base_vocabulary_placement_assessment.md) then checks the other 819 content roots and classifies thirty older roots where their lexical center is specialized. The current optional layer contains 246 roots and 355 memberships.
...
| [Systems and Shared Infrastructure](systems_and_shared_infrastructure.md) | **Established vocabulary module** | 24 | 37 | `phelure` store | System structure, inputs and outputs, control, feedback, technical state, upkeep, reliability, hazards, and specifications. |
| [Philosophical Reasoning](philosophical_reasoning.md) | **Established vocabulary module** | 18 | 21 | `sherewa` claim, `thesori` evidence, `remotha` reason, `kirema` criterion | Argument structure, evidence, inference, validity, definition, epistemic stance, rights, conscience, and competing values. |
...
| [Ecological Systems and Material Life](ecological_systems_and_material_life.md) | **Established vocabulary module** | 27 | 46 | `howenu` weather, `muralo` material, `panuri` resource | Ecological organization, land and water processes, weather and climate, pollution and exposure, material afterlives, and repeated ecological observation. |
