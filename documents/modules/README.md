...
The [Module overlap assessment](module_overlap_assessment.md) accounts for the 227 roots established during the eight original vocabulary passes. Seventy-seven of those have shared membership, 137 keep one module, and thirteen belong in base vocabulary. The [Base vocabulary placement assessment](base_vocabulary_placement_assessment.md) then checks the other 819 content roots and classifies thirty older roots where their lexical center is specialized. Later connected reviews added `hoshemi` hypothesis, nine Systems roots, three Ecological parameter nouns, and Commons `kowanu` governance and `pashenu` petition. The current optional layer contains 261 roots and 393 memberships.
...
| [Medical and Bodily Care](medical_and_bodily_care.md) | **Established vocabulary module** | 30 | 51 | `lesawi` consent | Symptoms, findings, health conditions, clinical evaluation, intervention effects, illness course, transmission, and public health. |
...
| [Philosophical Reasoning](philosophical_reasoning.md) | **Established vocabulary module** | 21 | 24 | `sherewa` claim, `thesori` evidence, `remotha` reason, `kirema` criterion | Argument structure, evidence, hypotheses, inference, validity, definition, epistemic stance, emergence, correlation, rights, conscience, and competing values. |
...
| [Commons and Collective Governance](commons_and_collective_governance.md) | **Established vocabulary module** | 29 | 53 | `sirami` record, `kawhera` coerce, `whepelo` retaliate | Membership, institutions, governance, authority, rights, petitions, collective procedure, allocation, accountability, records, review, and institutional harm. |
