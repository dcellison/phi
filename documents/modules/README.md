...
| [Ecological Systems and Material Life](ecological_systems_and_material_life.md) | **Established vocabulary module** | 30 | 57 | `howenu` weather, `muralo` material, `panuri` resource | Ecological organization, land and water processes, environmental parameters, weather and climate, pollution and exposure, material afterlives, energy, and repeated ecological observation. |
| [Work, Craft, and Repair](work_craft_and_repair.md) | **Established vocabulary module** | 28 | 74 | `winora` plan, `hasoru` pending | Work units and status, coordination, skill and qualification, training and evaluation, labor conditions, reward, design, built forms, electrical work, and material traceability. |
