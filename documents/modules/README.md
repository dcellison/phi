...
| [Medical and Bodily Care](medical_and_bodily_care.md) | **Established vocabulary module** | 30 | 52 | `lesawi` consent | Symptoms, findings, health conditions, clinical evaluation, intervention effects, illness course, transmission, and public health. |
...
| [Philosophical Reasoning](philosophical_reasoning.md) | **Established vocabulary module** | 25 | 28 | `sherewa` claim, `thesori` evidence, `remotha` reason, `kirema` criterion | Argument structure, evidence, hypotheses, inference, validity, definition, epistemic stance, emergence, correlation, rights, reason as a faculty, conscience, integrity, virtue, craving, and competing values. |
...
| [Commons and Collective Governance](commons_and_collective_governance.md) | **Established vocabulary module** | 29 | 54 | `sirami` record, `kawhera` coerce, `whepelo` retaliate | Membership, institutions, governance, authority, rights, petitions, collective procedure, allocation, accountability, records, review, and institutional harm. |
| [Ecological Systems and Material Life](ecological_systems_and_material_life.md) | **Established vocabulary module** | 30 | 55 | `howenu` weather, `muralo` material, `panuri` resource | Ecological organization, land and water processes, environmental parameters, weather and climate, pollution and exposure, material afterlives, energy, and repeated ecological observation. |
| [Work, Craft, and Repair](work_craft_and_repair.md) | **Established vocabulary module** | 28 | 71 | `winora` plan, `hasoru` pending | Work units and status, coordination, skill and qualification, training and evaluation, labor conditions, design, built forms, electrical work, and material traceability. |
