...
The [Module overlap assessment](module_overlap_assessment.md) accounts for the 227 roots established during the eight original vocabulary passes. Seventy-seven of those have shared membership, 137 keep one module, and thirteen belong in base vocabulary. The [Base vocabulary placement assessment](base_vocabulary_placement_assessment.md) then checks the other 819 content roots and classifies thirty older roots where their lexical center is specialized. Later connected reviews added `hoshemi` hypothesis, nine Systems roots, three Ecological parameter nouns, Commons `kowanu` governance and `pashenu` petition, and the Metta Sutta distinctions `serathi`, `taleri`, and `wurashi`. The current optional layer contains 264 roots and 398 memberships.
...
| [Work, Craft, and Repair](work_craft_and_repair.md) | **Established vocabulary module** | 28 | 70 | `winora` plan, `hasoru` pending | Work units and status, coordination, skill and qualification, training and evaluation, labor conditions, design, electrical work, and material traceability. |
