...
Philosophical Reasoning established the implementation pattern, Systems and Shared Infrastructure applied it to a second domain, and Ecological Systems and Material Life now applies it to a third: canonical JSON entries with validated module membership, a generated by-module index, and a curated Part VII chapter. The other active profiles may follow the same pattern when their vocabulary passes begin; their existing scenarios remain useful sources of ideas and examples rather than admission gates.
