...
| [Philosophical Reasoning](philosophical_reasoning.md) | **Established vocabulary module** | 24 | 27 | `sherewa` claim, `thesori` evidence, `remotha` reason, `kirema` criterion | Argument structure, evidence, hypotheses, inference, validity, definition, epistemic stance, emergence, correlation, rights, conscience, integrity, virtue, craving, and competing values. |
