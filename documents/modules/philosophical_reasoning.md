...
- [Grain for hunger and seed](../philosophical_test_corpus.md#11-grain-for-hunger-and-seed) and [The marker that was not reported](../philosophical_test_corpus.md#12-the-marker-that-was-not-reported) test competing claims, allocation, responsibility, imposed obligation, collective agency, justice, and action without complete agreement.
...
Select three regression dialogues with different operations: one competing-values decision, one evidential revision, and one definition or systems argument. For each dialogue, create one transformation that changes a premise while preserving the conclusion and one that changes the conclusion while preserving the premises.

Read the transformed Phi without its translations, identify every premise, conclusion, evidence source, modality, negation, participant, and discourse relation, and then introduce a clarification request, an evidence challenge, a retraction, and understood disagreement. Record every English rescue and classify it as retrieval, composition, missing convention, external-bridge need, or genuine shared-core gap.
