...
This release makes proper names productive under `ne` without adding a new particle or treating names as vocabulary. It also establishes optional lexical modules under one grammar and gives Philosophical Reasoning, Systems and Shared Infrastructure, and Ecological Systems and Material Life complete vocabulary passes. New words require implementation quality, not external proof of necessity. Any breaking lexical rename still requires recorded listening evidence and a migration table.
