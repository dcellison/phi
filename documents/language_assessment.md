...
These mechanisms establish a design boundary, not demonstrated usability. Exact data still needs a Phi explanation of its role, source pronunciation remains an outside convention, and productive names still need learner and listening evidence. The Systems module supplies terms for state, capacity, calibration, specifications, hazards, and other technical relations; the Ecological module supplies samples, baselines, trends, models, concentrations, exposures, and monitoring; the Commons module supplies institutions, authority, rules, decisions, entitlements, ownership, accountability, records, review, coercion, and retaliation; and the Work module supplies task structure, coordination, practical standing, evaluation, labor criticism, and material traceability. None interprets a source artifact or replaces domain expertise.

## What Remains Missing

1. **Precision beyond internal expression.** Separately preserved source material carries units, clock times, money, dates, dosages, technical values, laws, rights claims, credentials, contracts, and institutional wording, while Phi's internal ternary numerals express exact integers through 242 and the Systems, Ecological, Commons, and Work modules supply several relations around source records. Medical, economic, specialized legal, and cross-domain scientific interpretation remain much thinner, and no module term makes an exact source self-interpreting.
2. **Modern semantic coverage.** The lexicon is strong in household life, nature, craft, emotion, reflective practice, philosophical argument, foundational systems and ecological explanation, and foundational governance analysis. It remains thin in employment and political economy, disability and accessibility, reproductive health, sexuality, many contemporary technologies, and specialized sciences, medical systems, and legal systems.
3. **Sustained argument, systems, ecological, and governance use.** Phi now has terminology for validity, entailment, contradiction, counterexample, systems, feedback, ecosystems, ecological evidence, institutions, authority, allocation, accountability, records, coercion, and related operations, but those resources need sustained original use. Emergence, correlation, probability, several responsibility distinctions, and many work and care relations remain gaps or unconventionalized compositions.
