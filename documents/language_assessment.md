...
| Vocabulary | Moderate to hard | Roughly 900 content roots are mostly invented rather than internationally recognizable. |
...
These mechanisms establish a design boundary, not demonstrated usability. Exact data still needs a Phi explanation of its role, source pronunciation remains an outside convention, and productive names still need learner and listening evidence. The Systems module supplies terms for state, capacity, calibration, specifications, hazards, and other technical relations; the Ecological module supplies samples, baselines, trends, models, concentrations, exposures, and monitoring; the Commons module supplies institutions, authority, rules, decisions, entitlements, ownership, accountability, records, review, coercion, and retaliation; the Work module supplies task structure, coordination, practical standing, evaluation, labor criticism, and material traceability; and the Medical module supplies health observations, condition and course distinctions, clinical conclusions, interventions, effects, and public-health relations. None interprets a source artifact or replaces domain expertise.

## What Remains Missing

1. **Precision beyond internal expression.** Separately preserved source material carries units, clock times, money, dates, doses, technical values, medicine and vaccine identities, test results, diagnoses, laws, rights claims, credentials, contracts, and institutional wording, while Phi's internal ternary numerals express exact integers through 242 and the Systems, Ecological, Commons, Work, and Medical modules supply several relations around source records. Economic, specialized legal, advanced medical, and cross-domain scientific interpretation remain much thinner, and no module term makes an exact source self-interpreting.
2. **Modern semantic coverage.** The lexicon is strong in household life, nature, craft, emotion, reflective practice, philosophical argument, foundational systems and ecological explanation, foundational governance analysis, work organization, and foundational bodily care and public-health discussion. It remains thin in employment and political economy, disability and accessibility, reproductive health, sexuality, many contemporary technologies, and specialized sciences, advanced medical systems, and legal systems.
3. **Sustained specialist use.** Phi now has terminology for philosophical reasoning, systems, ecological evidence, governance, work, bodily care, clinical distinctions, and public-health relations, but those resources need sustained original use. Emergence, correlation, probability, several responsibility distinctions, advanced care relations, and many cross-module interactions remain gaps or unconventionalized compositions.
4. **Faithful surrounding analysis.** Separately preserved source material can retain harmful or tradition-specific terminology without endorsing it, and Commons now makes coercion, retaliation, authority, and institutional criticism more direct. Abuse, identity, medicine, source-specific political history, and many forms of institutional harm still require scenario-tested surrounding analysis.
