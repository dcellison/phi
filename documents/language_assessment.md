...
The new mechanisms establish carriage, not demonstrated usability. Exact data still needs a Phi explanation of its role, guest adaptations still require shared pronunciation, and productive names still need learner and listening evidence. The Systems module now supplies terms for state, capacity, calibration, specifications, hazards, and other surrounding relations, but it does not interpret a source value or replace domain expertise.

## What Remains Missing

1. **Precision beyond carriage.** The exact register preserves units, clock times, money, dates, dosages, and technical values, and the Systems module now supplies several relations needed around technical data. Medical, ecological, legal, economic, and scientific interpretation remain much thinner, and no module term makes an exact source self-interpreting.
2. **Modern semantic coverage.** The lexicon is strong in household life, nature, craft, emotion, reflective practice, philosophical argument, and foundational systems explanation. It remains thin in science, government, law, employment, disability, reproductive health, sexuality, and contemporary institutions.
3. **Sustained argument and systems use.** Phi now has terminology for validity, entailment, contradiction, counterexample, systems, feedback, and related operations, but those resources need sustained original use. Emergence, correlation, models, probability, and several responsibility distinctions remain gaps or unconventionalized compositions.
