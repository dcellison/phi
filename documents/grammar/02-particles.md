...
### 2.2.1. Tense
- `to` (PST): `mia to shelomui` (I understood)
- `so` (FUT): `mia so shelomui` (I will understand)
- Present: unmarked default

### 2.2.2. Aspect
- `ki` (PFV): `mia to ki shelomui` (I have understood)
- `si` (IPFV): `mia si shelomui` (I am understanding)
- `pa` (INCH): `mia pa shelomui` (I begin to understand)
- `te` (CESS): `mia te shelomui` (I stop understanding)
...
### 2.2.6. Negation
- `ma` (NEG): `shia ma shelomui` (The other does not understand)
...
**Ordinal:**
- `nu` (ORD): `nu ta lopia` (first child)

**Focus:**
- `ko` (FOC): `mia ko lothea shelomui` (I understand *love*)
