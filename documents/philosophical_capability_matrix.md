...
| Technical precision | External bridge | `patha … patho`; Systems terms for state, capacity, calibration, specification, inspection, reliability, and hazard; Ecological terms for sample, baseline, trend, model, concentration, exposure, and monitoring | Module words explain the role of exact material but cannot replace its values, units, notation, version, provenance, representativeness, or qualified interpretation | Test formulas, dates, units, citations, identifiers, calibration records, specifications, sample records, model versions, concentrations, and monitoring results in each writing mode |
