...
Continue the current-documents sweep with `documents/design/` and `documents/modules/`, then the evaluation corpus, then PED-08 at chapter 8. The `nai`-order fork awaits its ruling before any normalization pass.
