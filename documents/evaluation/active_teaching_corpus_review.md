...
| `ch01_why_new_language/03_what_phi_attempts.md` | Revised | The lexicon size, literary shelf, translation and transmutation account, and five-pillar boundary now describe the current project. The reviewed *North Wind and the Sun* moral remains exact. |
...
| `reference/language_guide.md` | Revised | The three samples end in periods and lint for the first time; the mindful-building sample takes the ruled descriptor position and the corpus gloss labels; the greeting header stops calling love a greeting; §2.2 stops saying the particles name how a claim is known; the transmutation back-translation matches `muroa` (fertile); the old title-case furniture takes sentence case; the learning path gains the breath-given-shape line. |
