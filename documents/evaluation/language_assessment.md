...
3. **Sustained specialist use.** The eight modules give Phi considerably more specialist language, but most of it has not yet appeared in sustained original work. Emergence and correlation now have dedicated module words, though neither has yet carried a sustained connected analysis. Probability remains compositional or source-bound according to whether an exact value is at stake, while several responsibility distinctions still require explicit relations. Advanced care relations and many cross-module interactions are also untested or unconventionalized.
