...
| Question | Close translation | Transmutation |
|---|---|---|
| Complete source boundary | All 33 source propositions and images receive a Phi unit, including the dog, well, coffer, myrtle, orchard, ocean, rent bosom, witness, yoke, and wings. | The same 33 citations remain. Every omission or altered claim is therefore visible against the adjacent source rather than hidden by selection. |
| Possessions and fear | Commons `phenori` names ownership; the careful dog hides bones in pathless sand while following people to a sacred place. Fear remains identified with need and thirst as Gibran claims. | Holding the next day in fear gives way to opening the hand today. The prudent dog remains but no longer supplies a lesson in anxious hoarding. |
| Motive, pain, and virtue | Recognition, hidden desire, joy, pain, virtue, fragrance, and divine action each receive their own relation. `thaweno` preserves Gibran's reward rather than changing it into a gift. | Joy may be a reward, but the gift does not require it. Pain is not a baptism or proof of goodness, and mindful giving does not become a search for virtuous recognition. |
| Request and unasked giving | A polite whole-clause question supplies the request; `whuo ha haolu` then states giving without that speech. | The receiver's freedom enters the account. Unasked giving is no longer automatically better, because understanding another person does not replace their answer. |
| Deservingness and worth | `parelu` carries every desert claim while `rolia` keeps naked worth distinct. Orchard, pasture, days, nights, ocean, stream, cup, courage, confidence, generosity, and the opened chest remain. | The source's merit gate is named and rejected. A receiver's need and consent matter without making deservingness an essence or a condition of worth. |
| Myrtle, baptism, God, and holy city | Exact identities stay in Gibran's citations. Phi describes a shrub releasing a pleasant smell, a sacred water ceremony, a sacred spirit, and a sacred place. | The shrub remains materially present. Baptism and divine speech no longer govern the gift, and no new tradition-specific roots are created. |
| Giver and witness | Life gives to Life while the human giver is a person who observes. | Giving becomes a relation among giver, receiver, need, and present consent rather than a divine passage through a passive witness. |
...
| *The Prophet* selections | Gibran's 1923 text; all four selections paired | The close renderings preserve the source's sword, cross, bow, prudent dog, well, orchard, fields, and temple through direct vocabulary and material descriptions. Their transmutations answer suffering-as-proof, ownership, merit, debt, and compulsory labour without hiding what Gibran wrote. | Solarpunk and pre-industrial readings place seed, grain, bread, orchard, craft, and shared work in material practice; Buddhist and peace readings keep attention, consent, release, and refusal explicit. |
