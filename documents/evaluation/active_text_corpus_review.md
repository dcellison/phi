...
| `texts/gibran/on_love.md` | Transmutation | Reviewed | The selected source units align in order, and the final deictic-order residue is repaired. |
...
| `texts/gibran/on_giving.md` | Transmutation | Reviewed | Seven selected source units align in order, with the deliberate reward-to-gift turn stated openly. |
