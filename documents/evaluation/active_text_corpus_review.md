...
| Active dependencies | Update the chapter notes, review ledger, progress records, handoff, and phonetic-neighbour attestations | All 85 source units retain their exact Morris lines. Chapter 2's river language informed `tiripe`; chapters 2 and 3 remain the next separate retrofit passes. |
...
| *News from Nowhere*, chapters 1-3 | Complete Morris chapters; repaired chapter by chapter | Chapter 1 now separates views held from representative standing, alliance membership from council office, and authority from guidance. The railway wagon stops as the wish is formed. Later chapters keep psychiatric stigma with the narrator, distinguish commoners' entitlement from institutional authority, replace revenge with retaliation, and restore the political direction of reactionary novels. | Solarpunk and preindustrial commitments are native to Morris's work; Art Nouveau lives in architecture, clothing, and craft. Buddhist attention clarifies the narrator's inference. Peace linguistics names authority and stigma without cleaning the argument, coercion, or social contempt from the story. |
