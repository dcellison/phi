...
| meeting | `lona` (meeting) | A gathering event exists; test whether a dedicated verb *meet* is ever needed. |
...
The [Commons and Collective Governance module](modules/commons_and_collective_governance.md) now establishes 30 optional terms for members, representation, institutions, roles, delegation, authority, authorization, jurisdiction, legitimacy, rules, proposals, procedures, decisions, consensus, votes, abstention, allocation, entitlements, ownership, obligations, accountability, redress, enforcement, notification, records, review, appeals, amendments, coercion, and retaliation.

The pass keeps affected-party relations, constituencies, residence, citizenship, standing, government and polity categories, office titles, terms, succession, mandates, governance as a whole, agendas, quorums, counting systems, source-specific laws and rights, property categories, custody, scarcity, priority, compliance, investigation, findings, sanctions, publication, confidentiality, provisional decisions, implementation, repeal, revocation, corruption, domination, capture, and abuse of office compositional or exact as appropriate. Contracts, prices, money, wages, debt, profit, taxation, budgets, and wider political economy remain candidates for Work or a later Economic Systems profile rather than being imported under governance labels.

### Work, craft, and repair

Phi has unusually dense concrete coverage for workshops, tools, materials, making processes, physical qualities, teaching, learning, repair, restoration, and maintenance. The Systems module provides inspection, specification, fault, failure, hazard, reliability, and related technical terms, while the Commons module now provides role, delegation, authority, authorization, rules, decisions, ownership, obligation, accountability, records, review, coercion, and retaliation. Work-specific task, assignment, supervision, handoff, qualification, workload, wage, employment, contract, compensation, safe approval, and final responsibility remain much thinner.

The [Work, Craft, and Repair vocabulary audit](work_craft_repair_vocabulary_audit.md), [the wheel, the chisel, and the promised repair](philosophical_test_corpus.md#15-the-wheel-the-chisel-and-the-promised-repair), and the [Work, Craft, and Repair profile](modules/work_craft_and_repair.md) provide a detailed starting inventory. Its vocabulary pass can reuse Systems and Commons terms while addressing task structure, competence, approval and safe return to use, assignment, supervision, handoff, qualification, workload, wage, employment, contract, compensation, and final responsibility.
