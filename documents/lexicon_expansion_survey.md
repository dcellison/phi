...
The [Work, Craft, and Repair module](modules/work_craft_and_repair.md) now establishes 30 optional terms for tasks, projects, plans, progress, pending and blocked status, deadlines, schedules, assignment, coordination, supervision, handoffs, skills, competence, expertise, qualification, training, assessment, certification, design, testing, quality, workload, drudgery, exploitation, stock, inventories, supply, offcuts, and provenance.
