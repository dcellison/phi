...
In Phi, the object is always placed **before the verb.** This gives us the most common sentence structure in the language: **Subject-Object-Verb**.

Let's learn two new words:
*   `lothea`: love (as a noun)
*   `kela`: to understand

To say "I understand love," we follow the `S-O-V` pattern precisely:

*   **Phi:** `mia lothea kela.`
*   **Gloss:** `1SG love understand.`
*   **Translation:** I understand love.
