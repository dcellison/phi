...
| Resource | Purpose |
|---|---|
| [Language guide](language_guide.md) | Compact overview of Phi's grammar and use. |
| [Grammar references](grammar/) | Detailed references for particles, clause frames, numerals, syntax, discourse, and philosophical conversation. |
...
| [Work, Craft, and Repair vocabulary audit](work_craft_repair_vocabulary_audit.md) | Evidence-gate review of concrete craft coverage, work relations, semantic pressure, and source-material handling. |
