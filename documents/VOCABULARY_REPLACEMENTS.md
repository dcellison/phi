...
| believe | hishe | MEDIUM | Mental state |
| decide | nothe | MEDIUM | Mental action |
| gather | whao | MEDIUM | Collective action |
...
| several | soli | MEDIUM | Quantifier |
| rain | phera | MEDIUM | Weather |
...
1. **Phase 1**: Create all Tier 1 vocabulary with proper workflow
2. **Phase 2**: Systematically update all documentation files
3. **Phase 3**: Create Tier 2 vocabulary
4. **Phase 4**: Final documentation sweep
5. **Phase 5**: Verify consistency across all materials

## Quality Checks

- [ ] All replacements follow sound symbolism principles
- [ ] No duplicate concepts remain
- [ ] All examples remain grammatically correct
- [ ] Tutorial progression still makes sense
- [ ] No orphaned references to old words