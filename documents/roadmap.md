...
| Philosophical capability | **PARTIAL** | Matrix, repair conventions, and fourteen test dialogues exist; several operations remain gaps. |
...
| Original Phi corpus | **PARTIAL** | Fourteen philosophical dialogues exist; sustained essays and spontaneous transcripts do not. |
...
| PHL-02 | **DONE** | Fourteen original regression dialogues covering ecological tradeoff, repair/replace, evidential revision, external-language critique, definition under pressure, two measurement/systems challenges, bodily-care decision-making, two access cases, commons allocation, shared-infrastructure accountability, and two ecological-systems challenges. | `documents/philosophical_test_corpus.md` | Existing dialogues remain validated and revisable. |
...
| SEM-01B | **PARTIAL** | Evaluate the recorded proposed-profile catalogue. | `documents/modules/README.md`; Accessibility and Commons active; Ecological Systems gate satisfied by scenarios 13 and 14 | Create the zero-new-root ecological profile next; audit craft vocabulary and write a work-sharing scenario before creating Work, Craft, and Repair. |
| SEM-02 | **PARTIAL** | Map weak modern domains: technology, science, government, law, work, disability, reproductive health, sexuality, and institutions. | Assessment, survey, two access scenarios and profile, two commons scenarios and profile, and two ecological-systems scenarios | Organize the recurring ecological findings in a profile, then test accessibility outside meetings and a standing institution outside councils while keeping sensitive domains scenario-gated. |
| SEM-03 | **PARTIAL** | Solarpunk philosophical scenario corpus. | Original regression corpus now covers ecology, energy, care, consent, accessibility, commons allocation, collective decisions, accountability, watershed evidence, habitat, and material return | Continue with mutual aid, institutional failure beyond one council, climate and heat, and conflicting visions of a good future. |
...
| COR-02 | **DONE** | Fourteen original philosophical regression dialogues. | `documents/philosophical_test_corpus.md` | Preserve as baseline tests rather than polished doctrine. |
