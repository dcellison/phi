...
| SEM-01B | **READY** | Evaluate the recorded proposed-profile catalogue. | `documents/modules/README.md`; Commons and Collective Governance gate satisfied by scenarios 11 and 12 | Create the zero-new-root commons profile next; keep solarpunk cross-module and sensitive domains scenario-gated. |
| SEM-02 | **PARTIAL** | Map weak modern domains: technology, science, government, law, work, disability, reproductive health, sexuality, and institutions. | Assessment, survey, two access scenarios and profile, one allocation scenario, and one accountability scenario | Organize the recurring commons and governance findings in a profile, then test access outside meetings and institutions outside councils. |
