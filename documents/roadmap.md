...
| Evidence-led semantic growth | **PARTIAL** | Philosophical Reasoning, Systems and Shared Infrastructure, Ecological Systems and Material Life, Commons and Collective Governance, Work, Craft, and Repair, and Medical and Bodily Care have completed full vocabulary passes; Accessibility and Household still await theirs. |
| Practice and domain profiles | **PARTIAL** | Eight active profiles and a recorded proposed-profile catalogue exist; six are established vocabulary modules with speaker chapters, while two remain organizational profiles. |
| Original Phi corpus | **PARTIAL** | Fifteen philosophical dialogues exist; a corpus-wide after-state review is queued after the remaining two profile passes and the multi-module membership assessment, while sustained essays and spontaneous transcripts do not yet exist. |
...
| ID | Status | Deliverable | Evidence | Completion or next criterion |
|---|---|---|---|---|
| SEM-01 | **DONE** | Establish the coinage quality protocol: compare composition and coinage, choose freely, then require complete semantics, schema, sound, examples, and references. | Development protocol and six completed vocabulary passes | Apply the same quality standard without treating it as an external burden of proof. |
| SEM-01A | **PARTIAL** | Develop practice and domain profiles as optional lexical organization under one grammar. | Eight active profiles; Philosophical Reasoning has 22 module words, Systems and Shared Infrastructure has 25, and Ecological Systems and Material Life, Commons and Collective Governance, Work, Craft, and Repair, and Medical and Bodily Care each have 30, with generated indexing and speaker chapters; Medical also adds shared-core consent | Continue with Accessibility and Participation and Household and Daily Life. |
...
| SEM-01C | **PENDING** | Revisit active Phi texts after the current module set and membership review are complete. | Maintainer-directed sequencing: complete Accessibility and Household, then SEM-01D, before revising texts for expanded vocabulary | Inventory every active scenario, dialogue, story, teaching text, and translation; update wording where module vocabulary makes the meaning clearer or less evasive, and explicitly preserve deliberate before-state evidence. |
| SEM-01D | **PENDING** | Assess genuine multi-module vocabulary membership after all current modules are established. | The schema and tooling support a list of modules, but every current module entry has one designation because passes have used a de facto primary-module convention | Distinguish cross-module dependency from equal curricular membership, add multiple designations where speakers of either module should independently learn the word, regenerate indexes, and avoid tagging every merely useful word. |
| SEM-02 | **PARTIAL** | Map weak modern domains: technology, science, government, law, work, disability, reproductive health, sexuality, and institutions. | Assessment, survey, established Systems, Ecological, Commons, Work, and Medical vocabulary modules, two access scenarios and profile, and work and care scenarios | Test the Work and Medical modules beyond their source scenarios, inhabited-place heat and cooling, accessibility outside meetings, and a standing institution outside councils while keeping sensitive domains scenario-gated. |
...
| SEM-05 | **DONE** | Complete implementation standard for each new word. | Development protocol and 167 entries across the first six established modules, plus shared-core `lesawi` consent | Require full schema fields, bounded scope, semantic contrasts, examples, phonetic checks, appropriate core or module placement, and generated references. |
...
| SEM-07D | **DONE** | First work, craft, and repair vocabulary expansion. | 30 Work, Craft, and Repair module words, retained compositions and source boundaries, generated index, and Part VII teaching chapter | Use the module in original work, learning, repair, and labor writing and revise any term or composition that feels inadequate. |
