...
| Evidence-led semantic growth | **PARTIAL** | Philosophical Reasoning and Systems and Shared Infrastructure have completed full vocabulary passes; the remaining profiles still await theirs. |
| Practice and domain profiles | **PARTIAL** | Eight active profiles and a recorded proposed-profile catalogue exist; two are established vocabulary modules with speaker chapters, while six remain organizational profiles. |
...
| SEM-02 | **PARTIAL** | Map weak modern domains: technology, science, government, law, work, disability, reproductive health, sexuality, and institutions. | Assessment, survey, established Systems vocabulary module, two access scenarios and profile, two commons scenarios and profile, two ecological scenarios and profile, and the work/craft audit, scenario, and profile | Test non-workshop work relations, inhabited-place heat and cooling, accessibility outside meetings, and a standing institution outside councils while keeping sensitive domains scenario-gated. |
...
| SEM-05 | **DONE** | Complete implementation standard for each new word. | Development protocol and 47 entries across the first two established modules | Require full schema fields, bounded scope, semantic contrasts, examples, phonetic checks, appropriate module placement, and generated references. |
