...
| Evidence-led semantic growth | **PARTIAL** | Philosophical Reasoning, Systems and Shared Infrastructure, Ecological Systems and Material Life, Commons and Collective Governance, and Work, Craft, and Repair have completed full vocabulary passes; Medical, Accessibility, and Household still await theirs. |
| Practice and domain profiles | **PARTIAL** | Eight active profiles and a recorded proposed-profile catalogue exist; five are established vocabulary modules with speaker chapters, while three remain organizational profiles. |
| Original Phi corpus | **PARTIAL** | Fifteen philosophical dialogues exist; a corpus-wide after-state review is queued after the remaining three profile vocabulary passes, while sustained essays and spontaneous transcripts do not yet exist. |
...
| SEM-01C | **PENDING** | Revisit active Phi texts after the current module set is established. | Maintainer-directed sequencing: complete Medical, Accessibility, and Household before revising texts for expanded vocabulary | Inventory every active scenario, dialogue, story, teaching text, and translation; update wording where module vocabulary makes the meaning clearer or less evasive, and explicitly preserve deliberate before-state evidence. |
| SEM-02 | **PARTIAL** | Map weak modern domains: technology, science, government, law, work, disability, reproductive health, sexuality, and institutions. | Assessment, survey, established Systems, Ecological, Commons, and Work vocabulary modules, two access scenarios and profile, and the work/craft audit and scenario | Test the Work module outside workshop settings, inhabited-place heat and cooling, accessibility outside meetings, and a standing institution outside councils while keeping sensitive domains scenario-gated. |
...
| SEM-05 | **DONE** | Complete implementation standard for each new word. | Development protocol and 137 entries across the first five established modules | Require full schema fields, bounded scope, semantic contrasts, examples, phonetic checks, appropriate module placement, and generated references. |
