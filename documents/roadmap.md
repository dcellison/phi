...
| Philosophical capability | **PARTIAL** | Matrix, repair conventions, and ten test dialogues exist; several operations remain gaps. |
...
| PHL-02 | **DONE** | Ten original regression dialogues covering ecological tradeoff, repair/replace, evidential revision, external-language critique, definition under pressure, two measurement/systems challenges, bodily-care decision-making, physical and communication access, and timing and decision-process access. | `documents/philosophical_test_corpus.md` | Existing dialogues remain validated and revisable. |
...
| COR-02 | **DONE** | Ten original philosophical regression dialogues. | `documents/philosophical_test_corpus.md` | Preserve as baseline tests rather than polished doctrine. |
