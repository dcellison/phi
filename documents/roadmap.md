...
| SEM-01C | **NEXT** | Revisit active Phi texts after the current module set and membership review are complete. | All eight active profiles and the module membership review are complete | Inventory every active scenario, dialogue, story, teaching text, and translation; update wording where module vocabulary makes the meaning clearer or less evasive, and explicitly preserve deliberate before-state evidence. |
