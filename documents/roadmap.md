...
| Practice and domain profiles | **PARTIAL** | An experimental contract, six domain profiles, one shared-core practice profile, one cross-domain accessibility profile, and a recorded proposed-profile catalogue exist. The format still needs use evidence. |
