...
| Philosophical capability | **PARTIAL** | Matrix, repair conventions, and nine test dialogues exist; several operations remain gaps. |
...
| Original Phi corpus | **PARTIAL** | Nine philosophical dialogues exist; sustained essays and spontaneous transcripts do not. |
...
| PHL-02 | **DONE** | Nine original regression dialogues covering ecological tradeoff, repair/replace, evidential revision, external-language critique, definition under pressure, two measurement/systems challenges, bodily-care decision-making, and accessibility. | `documents/philosophical_test_corpus.md` | Existing dialogues remain validated and revisable. |
...
| PHL-05 | **READY** | Test compositional operations: cause versus reason, retraction, competing goods, responsibility, uncertainty, and suspended judgment. | Matrix rows and solo evaluation tasks | Perform argument transformations and record where paraphrase loses a distinction. |
...
| SEM-01A | **PARTIAL** | Test domain modules as shared-core, non-grammatical profiles. | Module contract; Household and Daily Life; Medical and Bodily Care; Systems and Shared Infrastructure; Philosophical Reasoning | Run each profile's next-use test before treating the format as a durable extension policy. |
| SEM-01B | **READY** | Evaluate the recorded proposed-profile catalogue. | `documents/modules/README.md` | Create a proposed profile only after its stated scenario and boundary gate is met; keep solarpunk cross-module and sensitive domains scenario-gated. |
| SEM-02 | **PARTIAL** | Map weak modern domains: technology, science, government, law, work, disability, reproductive health, sexuality, and institutions. | `documents/language_assessment.md`; `documents/lexicon_expansion_survey.md`; first accessibility scenario | Add independent access and institutional scenarios, then identify which recurring distinctions are core goals. |
...
| COR-02 | **DONE** | Nine original philosophical regression dialogues. | `documents/philosophical_test_corpus.md` | Preserve as baseline tests rather than polished doctrine. |
