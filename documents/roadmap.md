...
| SEM-01B | **PARTIAL** | Evaluate the recorded proposed-profile catalogue. | `documents/modules/README.md`; Accessibility, Commons, and Ecological Systems moved to active after satisfying their gates | Audit craft vocabulary and write a work-sharing scenario before creating Work, Craft, and Repair; keep solarpunk cross-module and sensitive domains scenario-gated. |
| SEM-02 | **PARTIAL** | Map weak modern domains: technology, science, government, law, work, disability, reproductive health, sexuality, and institutions. | Assessment, survey, two access scenarios and profile, two commons scenarios and profile, and two ecological scenarios and profile | Test inhabited-place heat and cooling, accessibility outside meetings, and a standing institution outside councils while keeping sensitive domains scenario-gated. |
