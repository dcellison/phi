...
A sentence like `no thepalu kofe` (Help the garden) is not a command to be obeyed, but an invitation to participate in a communal goal. It reframes the very nature of instruction, transforming it from an act of imposing one's will onto another into an act of building consensus and shared responsibility. This seemingly small grammatical choice is a direct embodiment of Peace Linguistics, subtly but powerfully guiding its speakers away from the language of hierarchy and toward the language of mutual aid.
