...
## The two failures this skill guards against
...
Everything below is built to catch these two failures before they reach a file.
...
- If the source is still under active copyright, do not quote it at length. Work from short, sparing excerpts only, skip the source-quote-line convention in step 5, and say so plainly in the file's own intro paragraph.
...
## 6. State the transmutation, don't narrate the drafting
