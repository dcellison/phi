...
phi's approach to pragmatics is distinguished by its principle of systematic explicitness. rather than relying heavily on contextual inference and unstated cultural assumptions, phi utilizes its particle system and grammatical structure to overtly mark pragmatic functions such as evidentiality, discourse organization, speaker stance, and politeness. this design aims to enhance clarity, reduce ambiguity, and facilitate more transparent communication, particularly in cross-cultural contexts, by making the intended meaning more directly accessible from the linguistic form itself. 