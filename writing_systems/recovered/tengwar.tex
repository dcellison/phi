...
reduce ambiguity. As well, word markers are often used in Phi Tengwar to
distinguish multisyllabic words for clarity. The Phi Tengwar punctuation is
outlined in Table~\ref{tab:tengwar-punctuation}. As an example, the phrase
